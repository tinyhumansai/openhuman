...
const SNAPSHOT_HEADER: &str = "# 🧠 Alphahuman Memory Snapshot\n\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 Alphahuman Memory Snapshot

> Auto-generated by Alphahuman.
...
I am Alphahuman, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 Alphahuman Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
