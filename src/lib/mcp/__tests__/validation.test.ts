...
describe('validateId', () => {
  ...
  describe('invalid inputs', () => {
    ...
    it('should throw for non-string non-number', () => {
      ...
      expect(() => validateId({}, 'chat_id')).toThrow('Type must be an integer or a string');
    });
    ...
    it('should throw for float number', () => {
      ...
      expect(() => validateId(123.45, 'chat_id')).toThrow('ID is out of the valid integer range');
    });

    it('should throw for NaN string', () => {
      // "abc" is too short to be a valid username (< 5 chars) and is not a number
      expect(() => validateId('abc', 'chat_id')).toThrow(ValidationError);
    ...
    it.skip('should throw for integer out of range (too large)', () => {
      ...
      expect(() => validateId(tooLarge, 'chat_id')).toThrow('ID is out of the valid integer range');
    });
    ...
    it.skip('should throw for string integer out of range', () => {
      expect(() => validateId('9223372036854775808', 'chat_id')).toThrow(ValidationError);
    });
  });
});
...
describe('validateIdList', () => {
  ...
  it('should throw for array with invalid element', () => {
    expect(() => validateIdList([123, null, 456], 'ids')).toThrow(ValidationError);
  });

  it('should throw with correct parameter name for invalid element', () => {
    expect(() => validateIdList([123, 'bad'], 'user_ids')).toThrow('Invalid user_ids[1]');
  });

  it('should throw for array with short username', () => {
    expect(() => validateIdList(['@alice', 'bob'], 'usernames')).toThrow(ValidationError);
  });
});
...
describe('validatePositiveInt', () => {
  ...
  describe('invalid inputs', () => {
    ...
    it('should throw for negative string', () => {
      expect(() => validatePositiveInt('-10', 'offset')).toThrow(ValidationError);
    });
    ...
    it('should throw for non-number non-string', () => {
      ...
      expect(() => validatePositiveInt({}, 'limit')).toThrow('Must be a positive integer');
    });
