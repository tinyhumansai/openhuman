...
pub use schema::{
    ...
    MultimodalConfig, ObservabilityConfig, OrchestratorModelConfig, KalshiConfig,
    KalshiCredentials, PolymarketClobCredentials, PolymarketConfig, ProxyConfig, ProxyScope,
