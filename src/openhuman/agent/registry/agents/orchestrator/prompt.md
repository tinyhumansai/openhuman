...
Default bias: **do not spawn a sub-agent when a direct response or direct tool call is sufficient** — but live external-service, scheduling, presentation, product-docs, code-repo, market, and crypto requests belong to their specialists.
