...
impl ToolPolicyMiddleware {
    ...
    fn channel_permission_block(&self, call: &TaToolCall) -> Option<String> {
        ...
        if call_required > decision.allowed_permission {
            return Some(PolicyDenial::PermissionTooLow {
                tool: &call.name,
