...
use crate::openhuman::memory_tree::store::{self, ListChunksQuery};
...
pub async fn trigger_digest_rpc(
    ...
    use crate::openhuman::memory_tree::jobs;
...
pub async fn backfill_status_rpc(
    ...
    let in_progress =
        crate::openhuman::memory_tree::jobs::backfill_in_progress() || pending_jobs > 0;
    Ok(RpcOutcome::single_log(
...
mod tests {
    use super::*;
    use crate::openhuman::memory_tree::jobs::store::count_total;
