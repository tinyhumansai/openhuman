pub(super) fn is_text_role(role: Option<&str>) -> bool {
    matches!(
...
pub(super) fn is_terminal_app(app_name: Option<&str>) -> bool {
...
pub(super) fn looks_like_terminal_buffer(text: &str) -> bool {
...
pub(super) fn extract_terminal_input_context(text: &str) -> String {
