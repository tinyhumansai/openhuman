...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria':
    'Rango de confianza {range}: predicho {predicted} por ciento, real {actual} por ciento, {n} resueltos',
  'predictionLedger.brierHint': 'Más bajo es mejor — 0 es perfecto, 0,25 es lanzar una moneda.',
  'predictionLedger.brierLabel': 'Puntuación de Brier',
  'predictionLedger.categoryLabel': 'Categoría (opcional)',
  'predictionLedger.confidenceLabel': 'Confianza (%)',
  'predictionLedger.curveActual': 'Real',
  'predictionLedger.curveHeading': 'Curva de calibración',
  'predictionLedger.curvePredicted': 'Predicho',
  'predictionLedger.decompositionHint':
    'Brier = fiabilidad − resolución + incertidumbre. Menor fiabilidad y mayor resolución son mejores.',
  'predictionLedger.deleteAria': 'Eliminar predicción «{statement}»',
  'predictionLedger.deleteButton': 'Eliminar',
  'predictionLedger.deleteModalMessage':
    '¿Eliminar esta predicción permanentemente? Esto no se puede deshacer.',
  'predictionLedger.deleteModalTitle': 'Eliminar predicción',
  'predictionLedger.empty': 'Aún no hay predicciones.',
  'predictionLedger.emptyHint':
    'Registre una predicción con su nivel de confianza, luego resuélvala más tarde para empezar a evaluar su calibración.',
  'predictionLedger.errorPrefix': 'No se pudieron cargar las predicciones:',
  'predictionLedger.intro':
    'Registre predicciones con su nivel de confianza, resuélvalas como verdaderas o falsas, y vea qué tan bien calibrada está su previsión a lo largo del tiempo: su puntuación de Brier, curva de calibración, y si tiende a ser sobre o sub-confiado.',
  'predictionLedger.loading': 'Cargando predicciones…',
  'predictionLedger.meanConfidenceLabel': 'Confianza media',
  'predictionLedger.openHeading': 'Abiertas',
  'predictionLedger.overconfidentLabel': 'Sobreconfiado',
  'predictionLedger.overdueBadge': 'Vencidas',
  'predictionLedger.predictedVsOutcome': 'Predicho {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'Fiabilidad',
  'predictionLedger.resolutionLabel': 'Resolución',
  'predictionLedger.resolveAria': 'Resolver «{statement}» como {outcome}',
  'predictionLedger.resolveByLabel': 'Resolver antes de (opcional)',
  'predictionLedger.resolveFalse': 'No se cumplió',
  'predictionLedger.resolveTrue': 'Se cumplió',
  'predictionLedger.resolvedHeading': 'Resueltas',
  'predictionLedger.saveFailed': 'No se pudo guardar la predicción.',
  'predictionLedger.saved': 'Predicción guardada.',
  'predictionLedger.statementLabel': 'Predicción',
  'predictionLedger.statementPlaceholder': 'p. ej. El despliegue sale el viernes',
  'predictionLedger.title': 'Calibración de predicciones',
  'predictionLedger.trendCaption': '{first} → {last} sobre {n} resueltos (más bajo es mejor)',
  'predictionLedger.trendHeading': 'Brier a lo largo del tiempo',
  'predictionLedger.uncertaintyLabel': 'Incertidumbre',
  'predictionLedger.underconfidentLabel': 'Subconfiado',
  'predictionLedger.wellCalibratedLabel': 'Bien calibrado',
};
