...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthCallbackHint':
    'Después de iniciar sesión, pegue la URL de redirección completa de su navegador (comienza con http://127.0.0.1:1455/).',
  ...
  'onboarding.apiKeys.oauthStartFailed':
    'No se pudo iniciar el inicio de sesión con ChatGPT. Inténtelo de nuevo o utilice una clave API.',
  'onboarding.apiKeys.oauthPasteRedirect':
    'Pegue la URL de redirección de su navegador después de iniciar sesión.',
  'onboarding.apiKeys.oauthCompleteFailed':
    'El inicio de sesión con ChatGPT no se completó. Compruebe la URL de redirección e inténtelo de nuevo.',
