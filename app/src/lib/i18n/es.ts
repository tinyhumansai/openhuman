...
const messages: TranslationMap = {
  ...
  'settings.agentbox.desc': 'Estado del adaptador del mercado de GMI Cloud y configuración del proveedor',
  'settings.agentbox.intro': 'Estado de solo lectura del adaptador del mercado AgentBox. El modo y el proveedor GMI MaaS se establecen mediante variables de entorno al iniciar el núcleo.',
  ...
  'settings.agentbox.notConfigured': 'Sin configurar. Establece las variables de entorno GMI_MAAS_BASE_URL, GMI_MAAS_API_KEY y GMI_MODELS.',
