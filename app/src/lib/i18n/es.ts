...
const messages: TranslationMap = {
  ...
  'brain.profile.description':
    'Hechos que el agente ha deducido sobre tu forma de trabajar. Fíjalos para conservarlos; olvídalos para impedir que vuelvan.',
  'brain.profile.loading': 'Cargando preferencias…',
  'brain.profile.empty':
    'Aún no hay preferencias aprendidas. Activa el autoaprendizaje y sigue conversando, o reconstruye el perfil cuando llegue nueva evidencia.',
  'brain.profile.rebuild': 'Reconstruir',
  'brain.profile.rebuilding': 'Reconstruyendo…',
  'brain.profile.pin': 'Fijar',
  'brain.profile.unpin': 'Desfijar',
  'brain.profile.forget': 'Olvidar',
  'brain.profile.pinned': '(fijada)',
  ...
  'brain.profile.class.veto': 'Vetos',
  'brain.profile.class.goal': 'Objetivos',
  'brain.profile.class.channel': 'Canal',
  'brain.profile.class.other': 'Otro',
  ...
  'privacy.selfLearning': 'Autoaprendizaje',
  'privacy.selfLearningLabel': 'Aprender preferencias permanentes de chats y canales conectados',
  'privacy.selfLearningDesc':
    'Activado, OpenHuman puede deducir cómo te gusta trabajar a partir de chats y canales conectados e inyectar preferencias activas en sesiones nuevas. Está desactivado por defecto. Administra las preferencias aprendidas en Cerebro → Perfil.',
