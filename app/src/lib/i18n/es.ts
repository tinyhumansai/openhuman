...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'Confianza',
  'beliefLedger.confidenceAria': 'Confianza: {pct}%',
  'beliefLedger.conflictBadge': 'Contestado',
  'beliefLedger.correctionCustomLabel': 'O introduzca un valor diferente',
  'beliefLedger.correctionFailed': 'No se pudo guardar la corrección.',
  'beliefLedger.correctionModalMessage':
    '¿Guardar el valor seleccionado como la verdad confirmada para esta afirmación? El agente lo tratará como autoritativo en adelante.',
  'beliefLedger.correctionModalTitle': 'Establecer el valor correcto',
  'beliefLedger.correctionSaved': 'Corrección guardada.',
  'beliefLedger.correctionSelectAria': 'Elija el valor correcto para {claim}',
  'beliefLedger.currentBelief': 'actual',
  'beliefLedger.distinctValues': '{n} valores distintos',
  'beliefLedger.empty': 'Aún no hay creencias que mostrar.',
  'beliefLedger.emptyHint':
    'A medida que el agente aprende hechos sobre usted, aquí aparecerán contradicciones y revisiones a lo largo del tiempo.',
  'beliefLedger.errorPrefix': 'No se pudieron cargar las creencias:',
  'beliefLedger.evidence': 'Evidencia',
  'beliefLedger.evidenceAria': 'Cantidad de evidencia: {n}',
  'beliefLedger.explain': 'Explicar esta contradicción',
  'beliefLedger.explainAria': 'Explicar esta contradicción para {claim}',
  'beliefLedger.explaining': 'Explicando…',
  'beliefLedger.explanationHeading': 'Explicación',
  'beliefLedger.historyHeading': 'Historial de revisiones',
  'beliefLedger.intro':
    'Vea cómo cambió lo que el agente cree sobre usted a lo largo del tiempo. Cuando los recuerdos más nuevos contradicen los más antiguos sobre lo mismo, el registro muestra ambos, elige la mejor creencia actual y le permite corregirla.',
  'beliefLedger.loading': 'Cargando creencias…',
  'beliefLedger.revision.contradicted': 'contradicho',
  'beliefLedger.revision.refined': 'refinado',
  'beliefLedger.revision.reinforced': 'reforzado',
  'beliefLedger.revision.superseded': 'reemplazado',
  'beliefLedger.setTruth': 'Establecer la verdad',
  'beliefLedger.setTruthAria': 'Establecer la verdad para {claim}',
  'beliefLedger.title': 'Registro de creencias',
  'memory.tab.beliefs': 'Creencias',
};
