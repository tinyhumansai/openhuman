...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria':
    'Intervallo di confidenza {range}: previsto {predicted} per cento, reale {actual} per cento, {n} risolti',
  'predictionLedger.brierHint': 'Più basso è meglio — 0 è perfetto, 0,25 è un lancio di moneta.',
  'predictionLedger.brierLabel': 'Punteggio di Brier',
  'predictionLedger.categoryLabel': 'Categoria (opzionale)',
  'predictionLedger.confidenceLabel': 'Confidenza (%)',
  'predictionLedger.curveActual': 'Reale',
  'predictionLedger.curveHeading': 'Curva di calibrazione',
  'predictionLedger.curvePredicted': 'Previsto',
  'predictionLedger.decompositionHint':
    'Brier = affidabilità − risoluzione + incertezza. Affidabilità più bassa e risoluzione più alta sono migliori.',
  'predictionLedger.deleteAria': 'Elimina previsione «{statement}»',
  'predictionLedger.deleteButton': 'Elimina',
  'predictionLedger.deleteModalMessage':
    'Eliminare definitivamente questa previsione? Questa azione non può essere annullata.',
  'predictionLedger.deleteModalTitle': 'Elimina previsione',
  'predictionLedger.empty': 'Ancora nessuna previsione.',
  'predictionLedger.emptyHint':
    'Registra una previsione con il tuo livello di confidenza, poi risolvila più tardi per iniziare a valutare la tua calibrazione.',
  'predictionLedger.errorPrefix': 'Impossibile caricare le previsioni:',
  'predictionLedger.intro':
    'Registra le previsioni con il tuo livello di confidenza, risolvile come vere o false, e vedi quanto è ben calibrata la tua previsione nel tempo — il tuo punteggio di Brier, curva di calibrazione, e se tendi ad essere sopra- o sotto-confidente.',
  'predictionLedger.loading': 'Caricamento previsioni…',
  'predictionLedger.meanConfidenceLabel': 'Confidenza media',
  'predictionLedger.openHeading': 'Aperte',
  'predictionLedger.overconfidentLabel': 'Sopra-confidente',
  'predictionLedger.overdueBadge': 'Scadute',
  'predictionLedger.predictedVsOutcome': 'Previsto {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'Affidabilità',
  'predictionLedger.resolutionLabel': 'Risoluzione',
  'predictionLedger.resolveAria': 'Risolvi «{statement}» come {outcome}',
  'predictionLedger.resolveByLabel': 'Risolvi entro (opzionale)',
  'predictionLedger.resolveFalse': 'Non si è verificato',
  'predictionLedger.resolveTrue': 'Si è verificato',
  'predictionLedger.resolvedHeading': 'Risolte',
  'predictionLedger.saveFailed': 'Impossibile salvare la previsione.',
  'predictionLedger.saved': 'Previsione salvata.',
  'predictionLedger.statementLabel': 'Previsione',
  'predictionLedger.statementPlaceholder': 'es. Il rilascio parte venerdì',
  'predictionLedger.title': 'Calibrazione delle previsioni',
  'predictionLedger.trendCaption': '{first} → {last} su {n} risolti (più basso è meglio)',
  'predictionLedger.trendHeading': 'Brier nel tempo',
  'predictionLedger.uncertaintyLabel': 'Incertezza',
  'predictionLedger.underconfidentLabel': 'Sotto-confidente',
  'predictionLedger.wellCalibratedLabel': 'Ben calibrato',
};
