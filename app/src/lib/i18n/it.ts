...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'Confidenza',
  'beliefLedger.confidenceAria': 'Confidenza: {pct}%',
  'beliefLedger.conflictBadge': 'Contestato',
  'beliefLedger.correctionCustomLabel': 'Oppure inserisci un valore diverso',
  'beliefLedger.correctionFailed': 'Impossibile salvare la correzione.',
  'beliefLedger.correctionModalMessage':
    "Salvare il valore selezionato come verità confermata per questa affermazione? L'agente lo tratterà come autorevole in futuro.",
  'beliefLedger.correctionModalTitle': 'Imposta il valore corretto',
  'beliefLedger.correctionSaved': 'Correzione salvata.',
  'beliefLedger.correctionSelectAria': 'Scegli il valore corretto per {claim}',
  'beliefLedger.currentBelief': 'attuale',
  'beliefLedger.distinctValues': '{n} valori distinti',
  'beliefLedger.empty': 'Ancora nessuna credenza da mostrare.',
  'beliefLedger.emptyHint':
    "Man mano che l'agente apprende fatti su di te, qui appariranno contraddizioni e revisioni nel tempo.",
  'beliefLedger.errorPrefix': 'Impossibile caricare le credenze:',
  'beliefLedger.evidence': 'Evidenza',
  'beliefLedger.evidenceAria': 'Conteggio evidenze: {n}',
  'beliefLedger.explain': 'Spiega questa contraddizione',
  'beliefLedger.explainAria': 'Spiega questa contraddizione per {claim}',
  'beliefLedger.explaining': 'Spiegazione in corso…',
  'beliefLedger.explanationHeading': 'Spiegazione',
  'beliefLedger.historyHeading': 'Cronologia delle revisioni',
  'beliefLedger.intro':
    "Vedi come quello che l'agente crede su di te è cambiato nel tempo. Quando i ricordi più recenti contraddicono quelli più vecchi sulla stessa cosa, il registro mostra entrambi, sceglie la migliore credenza attuale, e ti permette di correggerla.",
  'beliefLedger.loading': 'Caricamento credenze…',
  'beliefLedger.revision.contradicted': 'contraddetto',
  'beliefLedger.revision.refined': 'raffinato',
  'beliefLedger.revision.reinforced': 'rinforzato',
  'beliefLedger.revision.superseded': 'sostituito',
  'beliefLedger.setTruth': 'Imposta la verità',
  'beliefLedger.setTruthAria': 'Imposta la verità per {claim}',
  'beliefLedger.title': 'Registro delle credenze',
  'memory.tab.beliefs': 'Convinzioni',
};
