...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria':
    'আত্মবিশ্বাস পরিসর {range}: ভবিষ্যদ্বাণী {predicted} শতাংশ, প্রকৃত {actual} শতাংশ, {n} সমাধানকৃত',
  'predictionLedger.brierHint': 'নিচু ভাল — 0 নিখুঁত, 0.25 মুদ্রা নিক্ষেপ।',
  'predictionLedger.brierLabel': 'Brier স্কোর',
  'predictionLedger.categoryLabel': 'বিভাগ (ঐচ্ছিক)',
  'predictionLedger.confidenceLabel': 'আত্মবিশ্বাস (%)',
  'predictionLedger.curveActual': 'প্রকৃত',
  'predictionLedger.curveHeading': 'ক্যালিব্রেশন বক্ররেখা',
  'predictionLedger.curvePredicted': 'ভবিষ্যদ্বাণী',
  'predictionLedger.decompositionHint':
    'Brier = নির্ভরযোগ্যতা − রেজোলিউশন + অনিশ্চয়তা। কম নির্ভরযোগ্যতা এবং বেশি রেজোলিউশন ভাল।',
  'predictionLedger.deleteAria': 'ভবিষ্যদ্বাণী «{statement}» মুছুন',
  'predictionLedger.deleteButton': 'মুছুন',
  'predictionLedger.deleteModalMessage':
    'এই ভবিষ্যদ্বাণীটি স্থায়ীভাবে মুছুন? এটি পূর্বাবস্থায় ফেরানো যাবে না।',
  'predictionLedger.deleteModalTitle': 'ভবিষ্যদ্বাণী মুছুন',
  'predictionLedger.empty': 'এখনও কোনো ভবিষ্যদ্বাণী নেই।',
  'predictionLedger.emptyHint':
    'আপনি কতটা আত্মবিশ্বাসী তা সহ একটি ভবিষ্যদ্বাণী লগ করুন, তারপর পরে এটি সমাধান করুন আপনার ক্যালিব্রেশন স্কোর করা শুরু করতে।',
  'predictionLedger.errorPrefix': 'ভবিষ্যদ্বাণী লোড করা যায়নি:',
  'predictionLedger.intro':
    'আপনি কতটা আত্মবিশ্বাসী তা সহ ভবিষ্যদ্বাণী লগ করুন, সেগুলি সত্য বা মিথ্যা হিসাবে সমাধান করুন, এবং দেখুন সময়ের সাথে আপনার পূর্বাভাস কতটা ভাল ক্যালিব্রেট — আপনার Brier স্কোর, ক্যালিব্রেশন বক্ররেখা, এবং আপনি অতি- বা অল্প-আত্মবিশ্বাসী হওয়ার প্রবণতা আছে কিনা।',
  'predictionLedger.loading': 'ভবিষ্যদ্বাণী লোড হচ্ছে…',
  'predictionLedger.meanConfidenceLabel': 'গড় আত্মবিশ্বাস',
  'predictionLedger.openHeading': 'খোলা',
  'predictionLedger.overconfidentLabel': 'অতি-আত্মবিশ্বাসী',
  'predictionLedger.overdueBadge': 'মেয়াদোত্তীর্ণ',
  'predictionLedger.predictedVsOutcome': 'ভবিষ্যদ্বাণী {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'নির্ভরযোগ্যতা',
  'predictionLedger.resolutionLabel': 'রেজোলিউশন',
  'predictionLedger.resolveAria': '«{statement}» কে {outcome} হিসাবে সমাধান করুন',
  'predictionLedger.resolveByLabel': 'সমাধান করুন (ঐচ্ছিক)',
  'predictionLedger.resolveFalse': 'ঘটেনি',
  'predictionLedger.resolveTrue': 'সত্য হয়েছে',
  'predictionLedger.resolvedHeading': 'সমাধানকৃত',
  'predictionLedger.saveFailed': 'ভবিষ্যদ্বাণী সংরক্ষণ করা যায়নি।',
  'predictionLedger.saved': 'ভবিষ্যদ্বাণী সংরক্ষিত।',
  'predictionLedger.statementLabel': 'ভবিষ্যদ্বাণী',
  'predictionLedger.statementPlaceholder': 'যেমন ডিপ্লয় শুক্রবার যায়',
  'predictionLedger.title': 'ভবিষ্যদ্বাণী ক্যালিব্রেশন',
  'predictionLedger.trendCaption': '{n} টি সমাধানকৃতের মধ্যে {first} → {last} (নিচু ভাল)',
  'predictionLedger.trendHeading': 'সময়ের সাথে Brier',
  'predictionLedger.uncertaintyLabel': 'অনিশ্চয়তা',
  'predictionLedger.underconfidentLabel': 'অল্প-আত্মবিশ্বাসী',
  'predictionLedger.wellCalibratedLabel': 'ভাল ক্যালিব্রেট',
};
