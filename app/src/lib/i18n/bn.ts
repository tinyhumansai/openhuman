...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'আত্মবিশ্বাস',
  'beliefLedger.confidenceAria': 'আত্মবিশ্বাস: {pct}%',
  'beliefLedger.conflictBadge': 'বিতর্কিত',
  'beliefLedger.correctionCustomLabel': 'অথবা একটি ভিন্ন মান লিখুন',
  'beliefLedger.correctionFailed': 'সংশোধন সংরক্ষণ করা যায়নি।',
  'beliefLedger.correctionModalMessage':
    'নির্বাচিত মানটি এই দাবির নিশ্চিত সত্য হিসাবে সংরক্ষণ করুন? এজেন্ট এটিকে এখন থেকে কর্তৃত্বপূর্ণ হিসাবে বিবেচনা করবে।',
  'beliefLedger.correctionModalTitle': 'সঠিক মান সেট করুন',
  'beliefLedger.correctionSaved': 'সংশোধন সংরক্ষিত।',
  'beliefLedger.correctionSelectAria': '{claim} এর জন্য সঠিক মান বেছে নিন',
  'beliefLedger.currentBelief': 'বর্তমান',
  'beliefLedger.distinctValues': '{n} টি স্বতন্ত্র মান',
  'beliefLedger.empty': 'এখনও দেখানোর জন্য কোনো বিশ্বাস নেই।',
  'beliefLedger.emptyHint':
    'এজেন্ট যখন আপনার সম্পর্কে তথ্য শেখে, সময়ের সাথে দ্বন্দ্ব এবং সংশোধন এখানে দেখা যাবে।',
  'beliefLedger.errorPrefix': 'বিশ্বাস লোড করা যায়নি:',
  'beliefLedger.evidence': 'প্রমাণ',
  'beliefLedger.evidenceAria': 'প্রমাণ গণনা: {n}',
  'beliefLedger.explain': 'এই দ্বন্দ্ব ব্যাখ্যা করুন',
  'beliefLedger.explainAria': '{claim} এর জন্য এই দ্বন্দ্ব ব্যাখ্যা করুন',
  'beliefLedger.explaining': 'ব্যাখ্যা চলছে…',
  'beliefLedger.explanationHeading': 'ব্যাখ্যা',
  'beliefLedger.historyHeading': 'সংশোধন ইতিহাস',
  'beliefLedger.intro':
    'দেখুন এজেন্ট আপনার সম্পর্কে কী বিশ্বাস করে তা সময়ের সাথে কীভাবে পরিবর্তিত হয়েছে। যখন নতুন স্মৃতি একই বিষয়ে পুরানোগুলির বিরুদ্ধে যায়, খতিয়ান উভয়ই দেখায়, বর্তমান সেরা বিশ্বাস বাছাই করে, এবং আপনাকে এটি সংশোধন করতে দেয়।',
  'beliefLedger.loading': 'বিশ্বাস লোড হচ্ছে…',
  'beliefLedger.revision.contradicted': 'বিরোধিত',
  'beliefLedger.revision.refined': 'পরিশোধিত',
  'beliefLedger.revision.reinforced': 'প্রবলিত',
  'beliefLedger.revision.superseded': 'প্রতিস্থাপিত',
