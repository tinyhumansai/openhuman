...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthConnected': 'ChatGPT-এর সাথে সংযুক্ত',
  ...
  'onboarding.apiKeys.oauthDesktopOnly':
    'ChatGPT সাইন-ইন শুধুমাত্র ডেস্কটপ অ্যাপে পাওয়া যায়।',
  'onboarding.apiKeys.oauthStartFailed':
    'ChatGPT সাইন-ইন শুরু করা যায়নি। আবার চেষ্টা করুন বা API কী ব্যবহার করুন।',
  ...
  'onboarding.apiKeys.oauthCompleteFailed':
    'ChatGPT সাইন-ইন সম্পন্ন হয়নি। রিডাইরেক্ট URL যাচাই করুন এবং আবার চেষ্টা করুন।',
