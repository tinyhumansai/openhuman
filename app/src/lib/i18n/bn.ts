...
const messages: TranslationMap = {
  ...
  'graphCohesion.title': 'গ্রাফ সংহতি',
  'graphCohesion.intro':
    'প্রতিটি সত্তার আশেপাশে প্রতিবেশীরা কতটা ঘনিষ্ঠভাবে যুক্ত। দালালরা — যেসব সত্তার প্রতিবেশীরা পরস্পরের সাথে যুক্ত নয় — তারা আলাদা ক্লাস্টারগুলিকে একসাথে ধরে রাখার একমাত্র বিন্দু, যা ফ্রিকোয়েন্সি বা PageRank ছাঁটাই প্রকাশ করতে পারে না।',
  'graphCohesion.loading': 'সংহতি গণনা করা হচ্ছে…',
  'graphCohesion.errorPrefix': 'গ্রাফ লোড করা যায়নি:',
  'graphCohesion.retry': 'আবার চেষ্টা করুন',
  'graphCohesion.empty': 'এখনো কোনো জ্ঞান গ্রাফ নেই।',
  'graphCohesion.emptyHint':
    'সহকারী আপনার সম্পর্কে সংযুক্ত তথ্য রেকর্ড করলে তাদের ক্লাস্টারিং কাঠামো এখানে দেখা যাবে।',
  'graphCohesion.namespaceLabel': 'নেমস্পেস',
  'graphCohesion.namespaceAll': 'সব নেমস্পেস',
  'graphCohesion.metricEntities': 'সত্তাসমূহ',
  'graphCohesion.metricConnections': 'সংযোগ',
  'graphCohesion.metricTriangles': 'ত্রিভুজ',
  'graphCohesion.summaryCaption': 'গড় ক্লাস্টারিং {avg} · ট্রানজিটিভিটি {transitivity}',
  'graphCohesion.noBrokers': 'এখনো দুটি বা তার বেশি সংযোগ সহ কোনো সত্তা নেই।',
  'graphCohesion.rankedHeading': 'দালালরা — সবচেয়ে শিথিল প্রতিবেশীত্ব',
  'graphCohesion.colRank': '#',
  'graphCohesion.colEntity': 'সত্তা',
  'graphCohesion.colCohesion': 'সংহতি',
  'graphCohesion.colLinks': 'লিংক',
  'graphCohesion.brokerBadge': 'দালাল',
  'graphCohesion.brokerTitle':
    'কাঠামোগত ফাঁক: এই সত্তার প্রতিবেশীরা একে অপরের সাথে সংযুক্ত নয় — এটিই তাদের মধ্যে একমাত্র সেতু।',
