...
const messages: TranslationMap = {
  ...
  'settings.agentbox.intro': 'AgentBox মার্কেটপ্লেস অ্যাডাপ্টারের শুধুমাত্র-পঠনযোগ্য অবস্থা। কোর চালু হওয়ার সময় মোড এবং GMI MaaS প্রদানকারী পরিবেশ ভেরিয়েবল দ্বারা সেট করা হয়।',
  ...
  'settings.agentbox.notConfigured': 'কনফিগার করা হয়নি। GMI_MAAS_BASE_URL, GMI_MAAS_API_KEY, এবং GMI_MODELS পরিবেশ ভেরিয়েবল সেট করুন।',
