...
const messages: TranslationMap = {
  ...
  'memory.tab.calibration': 'Calibração',
  'predictionLedger.addButton': 'Adicionar previsão',
  'predictionLedger.addHeading': 'Registrar uma previsão',
  'predictionLedger.baseRateLabel': 'Taxa base',
  'predictionLedger.binAria':
    'Faixa de confiança {range}: previsto {predicted} por cento, real {actual} por cento, {n} resolvidos',
  'predictionLedger.brierHint': 'Mais baixo é melhor — 0 é perfeito, 0,25 é um cara ou coroa.',
  'predictionLedger.brierLabel': 'Pontuação de Brier',
  'predictionLedger.categoryLabel': 'Categoria (opcional)',
  'predictionLedger.confidenceLabel': 'Confiança (%)',
  'predictionLedger.curveActual': 'Real',
  'predictionLedger.curveHeading': 'Curva de calibração',
  'predictionLedger.curvePredicted': 'Previsto',
  'predictionLedger.decompositionHint':
    'Brier = confiabilidade − resolução + incerteza. Menor confiabilidade e maior resolução são melhores.',
  'predictionLedger.deleteAria': 'Excluir previsão «{statement}»',
  'predictionLedger.deleteButton': 'Excluir',
  'predictionLedger.deleteModalMessage':
    'Excluir esta previsão permanentemente? Isto não pode ser desfeito.',
  'predictionLedger.deleteModalTitle': 'Excluir previsão',
  'predictionLedger.empty': 'Ainda sem previsões.',
  'predictionLedger.emptyHint':
    'Registre uma previsão com seu nível de confiança e resolva-a depois para começar a pontuar sua calibração.',
  'predictionLedger.errorPrefix': 'Não foi possível carregar as previsões:',
  'predictionLedger.intro':
    'Registre previsões com seu nível de confiança, resolva-as como verdadeiras ou falsas, e veja quão bem calibrada está sua previsão ao longo do tempo — sua pontuação de Brier, curva de calibração, e se você tende a ser super- ou sub-confiante.',
  'predictionLedger.loading': 'Carregando previsões…',
  'predictionLedger.meanConfidenceLabel': 'Confiança média',
  'predictionLedger.openHeading': 'Abertas',
  'predictionLedger.overconfidentLabel': 'Superconfiante',
  'predictionLedger.overdueBadge': 'Vencidas',
  'predictionLedger.predictedVsOutcome': 'Previsto {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'Confiabilidade',
  'predictionLedger.resolutionLabel': 'Resolução',
  'predictionLedger.resolveAria': 'Resolver «{statement}» como {outcome}',
  'predictionLedger.resolveByLabel': 'Resolver até (opcional)',
  'predictionLedger.resolveFalse': 'Não concretizou',
  'predictionLedger.resolveTrue': 'Concretizou-se',
  'predictionLedger.resolvedHeading': 'Resolvidas',
  'predictionLedger.saveFailed': 'Não foi possível salvar a previsão.',
  'predictionLedger.saved': 'Previsão salva.',
  'predictionLedger.statementLabel': 'Previsão',
  'predictionLedger.statementPlaceholder': 'ex. O deploy sai sexta',
  'predictionLedger.title': 'Calibração de previsões',
  'predictionLedger.trendCaption':
    '{first} → {last} ao longo de {n} resolvidos (mais baixo é melhor)',
  'predictionLedger.trendHeading': 'Brier ao longo do tempo',
  'predictionLedger.uncertaintyLabel': 'Incerteza',
  'predictionLedger.underconfidentLabel': 'Sub-confiante',
  'predictionLedger.wellCalibratedLabel': 'Bem calibrado',
};
