...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'Confiança',
  'beliefLedger.confidenceAria': 'Confiança: {pct}%',
  'beliefLedger.conflictBadge': 'Contestado',
  'beliefLedger.correctionCustomLabel': 'Ou insira um valor diferente',
  'beliefLedger.correctionFailed': 'Não foi possível salvar a correção.',
  'beliefLedger.correctionModalMessage':
    'Salvar o valor selecionado como a verdade confirmada para esta afirmação? O agente o tratará como autoritativo daqui para frente.',
  'beliefLedger.correctionModalTitle': 'Definir o valor correto',
  'beliefLedger.correctionSaved': 'Correção salva.',
  'beliefLedger.correctionSelectAria': 'Escolha o valor correto para {claim}',
  'beliefLedger.currentBelief': 'atual',
  'beliefLedger.distinctValues': '{n} valores distintos',
  'beliefLedger.empty': 'Ainda não há crenças para exibir.',
  'beliefLedger.emptyHint':
    'À medida que o agente aprende fatos sobre você, contradições e revisões ao longo do tempo aparecerão aqui.',
  'beliefLedger.errorPrefix': 'Não foi possível carregar as crenças:',
  'beliefLedger.evidence': 'Evidência',
  'beliefLedger.evidenceAria': 'Contagem de evidências: {n}',
  'beliefLedger.explain': 'Explicar esta contradição',
  'beliefLedger.explainAria': 'Explicar esta contradição para {claim}',
  'beliefLedger.explaining': 'Explicando…',
  'beliefLedger.explanationHeading': 'Explicação',
  'beliefLedger.historyHeading': 'Histórico de revisões',
  'beliefLedger.intro':
    'Veja como o que o agente acredita sobre você mudou ao longo do tempo. Quando memórias mais novas contradizem mais antigas sobre a mesma coisa, o registro exibe ambas, escolhe a melhor crença atual, e permite que você a corrija.',
  'beliefLedger.loading': 'Carregando crenças…',
  'beliefLedger.revision.contradicted': 'contradito',
  'beliefLedger.revision.refined': 'refinado',
  'beliefLedger.revision.reinforced': 'reforçado',
  'beliefLedger.revision.superseded': 'substituído',
