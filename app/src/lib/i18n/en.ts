...
const en: TranslationMap = {
  ...
  'relationshipTypes.intro':
    'A profile of the relationship vocabulary in your memory graph — which predicates connect facts, how often, and how often a relationship is mutual.',
  'relationshipTypes.loading': 'Profiling relationships…',
  'relationshipTypes.errorPrefix': 'Could not load the graph:',
  'relationshipTypes.retry': 'Retry',
  'relationshipTypes.namespaceLabel': 'Namespace',
  'relationshipTypes.namespaceAll': 'All namespaces',
  'relationshipTypes.empty': 'No knowledge graph yet.',
  'relationshipTypes.emptyHint':
    'As the assistant records related facts, the relationship types it uses will appear here.',
  'relationshipTypes.metricEdges': 'Edges',
  'relationshipTypes.metricPredicates': 'Predicates',
  'relationshipTypes.metricReciprocity': 'Reciprocity',
  'relationshipTypes.heading': 'Most-used relationships',
  'relationshipTypes.reciprocalShort': '{rate}% mutual',
  'relationshipTypes.reciprocalTitle': '{count} reciprocated',
  'relationshipTypes.truncated': 'Showing the top {shown} of {total} predicates.',
