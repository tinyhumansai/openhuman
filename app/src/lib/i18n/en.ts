...
const en: TranslationMap = {
  ...
  'welcome.connectPrompt': 'Enter a Core RPC URL to get started',
  ...
  // Onboarding
  'onboarding.welcome': 'Welcome to OpenHuman',
  'onboarding.welcomeDesc': "Let's get you set up in just a few steps.",
  ...
  // Chat (additional)
  'chat.safetyTimeout': 'Safety timeout reached',
  'chat.filter.all': 'All',
  ...
  'chat.noLabelThreads': 'No threads with this label',
  ...
  'chat.newThreadShortcut': 'New thread',
  'chat.new': 'New',
  ...
  'chat.weeklyLimitHit': 'Weekly limit reached.',
  'chat.resets': 'Resets',
  'chat.topUpToContinue': 'Top up to continue.',
  'chat.budgetComplete': 'Budget completed.',
  ...
  'workspace.graphLoadFailed': 'Could not load the memory graph',
  ...
  'sync.sync': 'Sync',
  'sync.failedToLoad': 'Failed to load',
  'sync.noContent': 'No content available',
