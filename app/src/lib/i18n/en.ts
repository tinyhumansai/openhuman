...
const en: TranslationMap = {
  ...
  'knowledgeGaps.intro':
    'The inverse of centrality: entities the assistant has barely recorded anything about — orphans (no connections) and leaves (a single connection) — the best candidates to learn more about.',
  ...
  'knowledgeGaps.metricEntities': 'Entities',
  'knowledgeGaps.metricOrphans': 'Orphans',
  'knowledgeGaps.metricLeaves': 'Leaves',
  'knowledgeGaps.ratioCaption': '{ratio}% of entities are sparsely connected',
  'knowledgeGaps.allConnected': 'Every entity is well-connected — no gaps found.',
  'knowledgeGaps.heading': 'Sparse entities',
  'knowledgeGaps.kindOrphan': 'orphan',
  'knowledgeGaps.kindLeaf': 'leaf',
  'knowledgeGaps.objectOnly': 'mentioned, never described',
  'knowledgeGaps.truncated': 'Showing {shown} of {total} sparse entities.',
