...
const en: TranslationMap = {
  ...
  'predictionLedger.title': 'Prediction Calibration',
  'predictionLedger.intro':
    'Log predictions with how confident you are, resolve them true or false, and see how well-calibrated your forecasting is over time — your Brier score, calibration curve, and whether you tend to be over- or under-confident.',
  'predictionLedger.loading': 'Loading predictions…',
  'predictionLedger.empty': 'No predictions yet.',
  'predictionLedger.emptyHint':
    'Log a prediction with how confident you are, then resolve it later to start scoring your calibration.',
  'predictionLedger.errorPrefix': 'Could not load predictions:',
  'predictionLedger.addHeading': 'Log a prediction',
  'predictionLedger.statementLabel': 'Prediction',
  'predictionLedger.statementPlaceholder': 'e.g. The deploy ships Friday',
  'predictionLedger.confidenceLabel': 'Confidence (%)',
  'predictionLedger.resolveByLabel': 'Resolve by (optional)',
  'predictionLedger.categoryLabel': 'Category (optional)',
  'predictionLedger.addButton': 'Add prediction',
  'predictionLedger.openHeading': 'Open',
  'predictionLedger.resolvedHeading': 'Resolved',
  'predictionLedger.resolveTrue': 'Came true',
  'predictionLedger.resolveFalse': 'Did not',
  'predictionLedger.overdueBadge': 'Overdue',
  'predictionLedger.deleteButton': 'Delete',
  'predictionLedger.deleteModalTitle': 'Delete prediction',
  'predictionLedger.deleteModalMessage':
    'Delete this prediction permanently? This cannot be undone.',
  'predictionLedger.saved': 'Prediction saved.',
  'predictionLedger.saveFailed': 'Could not save the prediction.',
  'predictionLedger.brierLabel': 'Brier score',
  'predictionLedger.brierHint': 'Lower is better — 0 is perfect, 0.25 is a coin flip.',
  'predictionLedger.baseRateLabel': 'Base rate',
  'predictionLedger.meanConfidenceLabel': 'Mean confidence',
  'predictionLedger.overconfidentLabel': 'Overconfident',
  'predictionLedger.underconfidentLabel': 'Underconfident',
  'predictionLedger.wellCalibratedLabel': 'Well calibrated',
  'predictionLedger.curveHeading': 'Calibration curve',
  'predictionLedger.curvePredicted': 'Predicted',
  'predictionLedger.curveActual': 'Actual',
  'predictionLedger.binAria':
    'Confidence bin {range}: predicted {predicted} percent, actual {actual} percent, {n} resolved',
  'predictionLedger.reliabilityLabel': 'Reliability',
  'predictionLedger.resolutionLabel': 'Resolution',
  'predictionLedger.uncertaintyLabel': 'Uncertainty',
  'predictionLedger.decompositionHint':
    'Brier = reliability − resolution + uncertainty. Lower reliability and higher resolution are better.',
  'predictionLedger.trendHeading': 'Brier over time',
  'predictionLedger.trendCaption': '{first} → {last} across {n} resolved (lower is better)',
  'predictionLedger.predictedVsOutcome': 'Predicted {predicted}% → {outcome}',
  'predictionLedger.resolveAria': 'Resolve "{statement}" as {outcome}',
  'predictionLedger.deleteAria': 'Delete prediction "{statement}"',
