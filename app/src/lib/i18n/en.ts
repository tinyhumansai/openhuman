...
const en: TranslationMap = {
  ...
  'beliefLedger.title': 'Belief Ledger',
  'beliefLedger.intro':
    'See how what the agent believes about you changed over time. When newer memories contradict older ones about the same thing, the ledger surfaces both, picks the current best belief, and lets you correct it.',
  'beliefLedger.loading': 'Loading beliefs…',
  'beliefLedger.empty': 'No beliefs to show yet.',
  'beliefLedger.emptyHint':
    'As the agent learns facts about you, contradictions and revisions over time will appear here.',
  'beliefLedger.errorPrefix': 'Could not load beliefs:',
  'beliefLedger.currentBelief': 'current',
  'beliefLedger.confidence': 'Confidence',
  'beliefLedger.evidence': 'Evidence',
  'beliefLedger.conflictBadge': 'Contested',
  'beliefLedger.historyHeading': 'Revision history',
  'beliefLedger.revision.reinforced': 'reinforced',
  'beliefLedger.revision.refined': 'refined',
  'beliefLedger.revision.superseded': 'superseded',
  'beliefLedger.revision.contradicted': 'contradicted',
  'beliefLedger.explain': 'Explain this contradiction',
  'beliefLedger.explaining': 'Explaining…',
  'beliefLedger.explanationHeading': 'Explanation',
