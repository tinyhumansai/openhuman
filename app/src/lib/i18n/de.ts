...
const messages: TranslationMap = {
  ...
  'brain.profile.description':
    'Fakten darüber, wie du gerne arbeitest, die der Agent abgeleitet hat. Pinne sie an, damit sie bleiben; vergiss sie, damit sie nicht wiederkehren.',
  'brain.profile.loading': 'Präferenzen werden geladen…',
  'brain.profile.empty':
    'Noch keine gelernten Präferenzen. Aktiviere das Selbstlernen und chatte weiter oder baue das Profil neu auf, sobald neue Hinweise vorliegen.',
  'brain.profile.rebuild': 'Neu aufbauen',
  'brain.profile.rebuilding': 'Wird neu aufgebaut…',
  'brain.profile.pin': 'Anpinnen',
  'brain.profile.unpin': 'Loslösen',
  'brain.profile.forget': 'Vergessen',
  'brain.profile.pinned': '(angepinnt)',
  ...
  'brain.profile.class.veto': 'Ablehnungen',
  'brain.profile.class.goal': 'Ziele',
  'brain.profile.class.channel': 'Kanal',
  'brain.profile.class.other': 'Andere',
  ...
  'privacy.selfLearning': 'Selbstlernen',
  'privacy.selfLearningLabel': 'Dauerhafte Präferenzen aus Chats und verbundenen Kanälen lernen',
  'privacy.selfLearningDesc':
    'Wenn aktiviert, kann OpenHuman aus Chats und verbundenen Kanälen ableiten, wie du gerne arbeitest, und aktive Präferenzen in neue Sitzungen einfügen. Standardmäßig deaktiviert. Verwalte gelernte Präferenzen unter Gehirn → Profil.',
