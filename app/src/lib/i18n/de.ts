...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria':
    'Konfidenzbereich {range}: vorhergesagt {predicted} Prozent, tatsächlich {actual} Prozent, {n} aufgelöst',
  'predictionLedger.brierHint': 'Niedriger ist besser — 0 ist perfekt, 0,25 ist ein Münzwurf.',
  'predictionLedger.brierLabel': 'Brier-Score',
  'predictionLedger.categoryLabel': 'Kategorie (optional)',
  'predictionLedger.confidenceLabel': 'Konfidenz (%)',
  'predictionLedger.curveActual': 'Tatsächlich',
  'predictionLedger.curveHeading': 'Kalibrierungskurve',
  'predictionLedger.curvePredicted': 'Vorhergesagt',
  'predictionLedger.decompositionHint':
    'Brier = Zuverlässigkeit − Auflösung + Unsicherheit. Niedrigere Zuverlässigkeit und höhere Auflösung sind besser.',
  'predictionLedger.deleteAria': 'Vorhersage „{statement}“ löschen',
  'predictionLedger.deleteButton': 'Löschen',
  'predictionLedger.deleteModalMessage':
    'Diese Vorhersage dauerhaft löschen? Dies kann nicht rückgängig gemacht werden.',
  'predictionLedger.deleteModalTitle': 'Vorhersage löschen',
  'predictionLedger.empty': 'Noch keine Vorhersagen.',
  'predictionLedger.emptyHint':
    'Protokollieren Sie eine Vorhersage mit Ihrer Konfidenz und lösen Sie sie später auf, um Ihre Kalibrierung zu bewerten.',
  'predictionLedger.errorPrefix': 'Vorhersagen konnten nicht geladen werden:',
  'predictionLedger.intro':
    'Protokollieren Sie Vorhersagen mit Ihrer Konfidenz, lösen Sie sie als wahr oder falsch auf und sehen Sie, wie gut kalibriert Ihre Prognose im Zeitverlauf ist — Ihr Brier-Score, Kalibrierungskurve und ob Sie zu über- oder unterkonfident neigen.',
  'predictionLedger.loading': 'Lade Vorhersagen…',
  'predictionLedger.meanConfidenceLabel': 'Durchschnittliche Konfidenz',
  'predictionLedger.openHeading': 'Offen',
  'predictionLedger.overconfidentLabel': 'Überkonfident',
  'predictionLedger.overdueBadge': 'Überfällig',
  'predictionLedger.predictedVsOutcome': 'Vorhergesagt {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'Zuverlässigkeit',
  'predictionLedger.resolutionLabel': 'Auflösung',
  'predictionLedger.resolveAria': '„{statement}“ als {outcome} auflösen',
  'predictionLedger.resolveByLabel': 'Auflösen bis (optional)',
  'predictionLedger.resolveFalse': 'Nicht eingetreten',
  'predictionLedger.resolveTrue': 'Eingetreten',
  'predictionLedger.resolvedHeading': 'Aufgelöst',
  'predictionLedger.saveFailed': 'Vorhersage konnte nicht gespeichert werden.',
  'predictionLedger.saved': 'Vorhersage gespeichert.',
  'predictionLedger.statementLabel': 'Vorhersage',
  'predictionLedger.statementPlaceholder': 'z. B. Das Release geht am Freitag live',
  'predictionLedger.title': 'Vorhersage-Kalibrierung',
  'predictionLedger.trendCaption': '{first} → {last} über {n} aufgelöst (niedriger ist besser)',
  'predictionLedger.trendHeading': 'Brier im Zeitverlauf',
  'predictionLedger.uncertaintyLabel': 'Unsicherheit',
  'predictionLedger.underconfidentLabel': 'Unterkonfident',
  'predictionLedger.wellCalibratedLabel': 'Gut kalibriert',
};
