...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'Konfidenz',
  'beliefLedger.confidenceAria': 'Konfidenz: {pct}%',
  'beliefLedger.conflictBadge': 'Bestritten',
  'beliefLedger.correctionCustomLabel': 'Oder einen anderen Wert eingeben',
  'beliefLedger.correctionFailed': 'Korrektur konnte nicht gespeichert werden.',
  'beliefLedger.correctionModalMessage':
    'Den ausgewählten Wert als bestätigte Wahrheit für diese Aussage speichern? Der Agent wird ihn künftig als autoritativ behandeln.',
  'beliefLedger.correctionModalTitle': 'Den korrekten Wert festlegen',
  'beliefLedger.correctionSaved': 'Korrektur gespeichert.',
  'beliefLedger.correctionSelectAria': 'Wählen Sie den korrekten Wert für {claim}',
  'beliefLedger.currentBelief': 'aktuell',
  'beliefLedger.distinctValues': '{n} verschiedene Werte',
  'beliefLedger.empty': 'Noch keine Überzeugungen anzuzeigen.',
  'beliefLedger.emptyHint':
    'Während der Agent Fakten über Sie lernt, erscheinen hier Widersprüche und Revisionen im Lauf der Zeit.',
  'beliefLedger.errorPrefix': 'Überzeugungen konnten nicht geladen werden:',
  'beliefLedger.evidence': 'Evidenz',
  'beliefLedger.evidenceAria': 'Evidenzanzahl: {n}',
  'beliefLedger.explain': 'Diesen Widerspruch erklären',
  'beliefLedger.explainAria': 'Diesen Widerspruch für {claim} erklären',
  'beliefLedger.explaining': 'Erkläre…',
  'beliefLedger.explanationHeading': 'Erklärung',
  'beliefLedger.historyHeading': 'Revisionsverlauf',
  'beliefLedger.intro':
    'Sehen Sie, wie sich die Überzeugungen des Agenten über Sie im Lauf der Zeit verändert haben. Wenn neuere Erinnerungen ältere zum gleichen Thema widerlegen, zeigt das Register beide, wählt die aktuell beste Überzeugung und lässt Sie sie korrigieren.',
  'beliefLedger.loading': 'Lade Überzeugungen…',
  'beliefLedger.revision.contradicted': 'widersprochen',
  'beliefLedger.revision.refined': 'verfeinert',
  'beliefLedger.revision.reinforced': 'verstärkt',
  'beliefLedger.revision.superseded': 'ersetzt',
  'beliefLedger.setTruth': 'Wahrheit festlegen',
  'beliefLedger.setTruthAria': 'Wahrheit für {claim} festlegen',
  'beliefLedger.title': 'Überzeugungsregister',
  'memory.tab.beliefs': 'Überzeugungen',
};
