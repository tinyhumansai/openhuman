...
const messages: TranslationMap = {
  ...
  'graphCohesion.intro':
    'مدى الترابط الشديد بين الجيران حول كل كيان. الوسطاء — الكيانات التي لا يرتبط جيرانها ببعضهم — هم نقاط الوصل الوحيدة بين مجموعات منفصلة لا يمكن لأي ترتيب بالتكرار أو PageRank الكشف عنها.',
  'graphCohesion.loading': 'جارٍ احتساب التماسك…',
  'graphCohesion.errorPrefix': 'تعذّر تحميل الرسم البياني:',
  'graphCohesion.retry': 'إعادة المحاولة',
  'graphCohesion.empty': 'لا يوجد رسم بياني للمعرفة بعد.',
  'graphCohesion.emptyHint':
    'عندما يسجّل المساعد حقائق مترابطة عنك، ستظهر بنيتها التجميعية هنا.',
  'graphCohesion.namespaceLabel': 'الفضاء الاسمي',
  'graphCohesion.namespaceAll': 'جميع الفضاءات الاسمية',
  'graphCohesion.metricEntities': 'الكيانات',
  'graphCohesion.metricConnections': 'الاتصالات',
  'graphCohesion.metricTriangles': 'المثلثات',
  'graphCohesion.summaryCaption': 'متوسط التجميع {avg} · الانتقالية {transitivity}',
  'graphCohesion.noBrokers': 'لا توجد كيانات باتصالين أو أكثر بعد.',
  'graphCohesion.rankedHeading': 'الوسطاء — أكثر الجوار انفتاحًا',
  'graphCohesion.colRank': '#',
  'graphCohesion.colEntity': 'الكيان',
  'graphCohesion.colCohesion': 'التماسك',
  'graphCohesion.colLinks': 'الروابط',
  'graphCohesion.brokerBadge': 'وسيط',
  'graphCohesion.brokerTitle':
    'ثغرة هيكلية: جيران هذا الكيان غير مرتبطين ببعضهم — فهو الحلقة الوحيدة التي تجمعهم.',
