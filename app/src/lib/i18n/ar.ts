...
const messages: TranslationMap = {
  ...
  'evidenceTrust.colDegree': 'علاقات',
  'evidenceTrust.colEntity': 'الكيان',
  'evidenceTrust.colRank': '#',
  'evidenceTrust.colTrust': 'حاصل الثقة',
  'evidenceTrust.degradedHint':
    'كل علاقة حالياً تحمل evidenceCount = 1، لذا ينهار حاصل الثقة إلى ثابت. تحتاج العدسة إلى قيم تأكيد متنوعة لتمييز الغزير-الرفيع عن الهادئ-الصلب.',
  'evidenceTrust.degradedTitle': 'إشارة الدليل شحيحة — املأ evidenceCount لفتح هذه العدسة.',
  'evidenceTrust.empty': 'لا يوجد رسم معرفي بعد.',
  'evidenceTrust.emptyHint': 'كلما سجّل المساعد علاقات مع evidenceCount عنك، سيظهر هنا ملف الثقة.',
  'evidenceTrust.entitiesHeading': 'ترتيب حاصل الثقة',
  'evidenceTrust.errorPrefix': 'تعذّر تحميل الرسم البياني:',
  'evidenceTrust.evidenceLabel': 'دل. {n}',
  'evidenceTrust.intro':
    'حاصل الثقة لكل كيان = متوسط الدليل لكل علاقة يشارك فيها. Gini الدليل يقيس مدى عدم تساوي تركز الدليل بين الكيانات. قائمة عمل ناقص التأكيد تشير إلى العلاقات التي ينخفض دليلها تحت عتبة مستمدة من الرسم — قائمة مراجعة القيّم.',
  'evidenceTrust.loading': 'حساب ملف الثقة…',
  'evidenceTrust.metricEntities': 'كيانات مرجحة',
  'evidenceTrust.metricEvidence': 'إجمالي الأدلة',
  'evidenceTrust.metricGini': 'Gini للدليل',
  'evidenceTrust.namespaceAll': 'كل مساحات الأسماء',
  'evidenceTrust.namespaceLabel': 'مساحة الأسماء',
  'evidenceTrust.noWorklist': 'لا توجد علاقات ناقصة التأكيد — كل تأكيد يفي بعتبة الدليل.',
  'evidenceTrust.pointsTo': 'يشير إلى',
  'evidenceTrust.predicatesHeading': 'مؤشر موثوقية المسندات',
  'evidenceTrust.retry': 'إعادة المحاولة',
  'evidenceTrust.summaryCaption': '{relations} علاقة متمايزة · عتبة ناقص-التأكيد {threshold}',
  'evidenceTrust.title': 'الثقة الموزونة بالدليل',
  'evidenceTrust.worklistHeading': 'قائمة عمل ناقصة التأكيد',
