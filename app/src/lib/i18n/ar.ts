...
const messages: TranslationMap = {
  ...
  'walkthrough.desc.start': 'ابدأ بمسار الإعداد الموصى به',
  ...
  'walkthrough.card.actionAria': 'متابعة {label}',
  ...
  'walkthrough.review.description':
    'هذا ملخص لمناطق الإعداد التي راجعتها. يمكنك توصيلها أو تغييرها لاحقًا في الإعدادات.',
  'walkthrough.review.skipped':
    'لقد تخطيت الإعداد. يمكنك تكوين هذه الخيارات في أي وقت من الإعدادات.',
  'walkthrough.review.empty': 'لم تتم مراجعة أي عناصر بعد.',
  'walkthrough.done.title': 'أنت جاهز تمامًا!',
  'walkthrough.done.description':
    'مساعدك جاهز للمساعدة. يمكنك توصيل الأدوات وتشغيل الأتمتة لاحقًا من الإعدادات.',
