...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthConnected': 'متصل بـ ChatGPT',
  'onboarding.apiKeys.openaiOauthCallbackHint':
    'بعد تسجيل الدخول، الصق رابط إعادة التوجيه الكامل من متصفحك (يبدأ بـ http://127.0.0.1:1455/).',
  'onboarding.apiKeys.oauthDesktopOnly':
    'تسجيل الدخول إلى ChatGPT متاح فقط في تطبيق سطح المكتب.',
  ...
  'onboarding.apiKeys.oauthPasteRedirect':
    'الصق رابط إعادة التوجيه من متصفحك بعد تسجيل الدخول.',
  'onboarding.apiKeys.oauthCompleteFailed':
    'لم يكتمل تسجيل الدخول إلى ChatGPT. تحقق من رابط إعادة التوجيه وحاول مرة أخرى.',
