...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'الثقة',
  'beliefLedger.confidenceAria': 'الثقة: {pct}%',
  'beliefLedger.conflictBadge': 'متنازع عليه',
  'beliefLedger.correctionCustomLabel': 'أو أدخل قيمة مختلفة',
  'beliefLedger.correctionFailed': 'تعذّر حفظ التصحيح.',
  'beliefLedger.correctionModalMessage':
    'حفظ القيمة المختارة كحقيقة مؤكدة لهذا التأكيد؟ سيعاملها الوكيل على أنها مرجعية من الآن فصاعداً.',
  'beliefLedger.correctionModalTitle': 'تعيين القيمة الصحيحة',
  'beliefLedger.correctionSaved': 'تم حفظ التصحيح.',
  'beliefLedger.correctionSelectAria': 'اختر القيمة الصحيحة لـ {claim}',
  'beliefLedger.currentBelief': 'الحالي',
  'beliefLedger.distinctValues': '{n} قيم متمايزة',
  'beliefLedger.empty': 'لا توجد معتقدات لعرضها بعد.',
  'beliefLedger.emptyHint':
    'كلما تعلّم الوكيل حقائق عنك، ستظهر هنا التناقضات والمراجعات عبر الزمن.',
  'beliefLedger.errorPrefix': 'تعذّر تحميل المعتقدات:',
  'beliefLedger.evidence': 'الدليل',
  'beliefLedger.evidenceAria': 'عدد الأدلة: {n}',
  'beliefLedger.explain': 'اشرح هذا التناقض',
  'beliefLedger.explainAria': 'اشرح هذا التناقض لـ {claim}',
  'beliefLedger.explaining': 'جاري الشرح…',
  'beliefLedger.explanationHeading': 'الشرح',
  'beliefLedger.historyHeading': 'سجل المراجعات',
  'beliefLedger.intro':
    'انظر كيف تغيرت معتقدات الوكيل عنك مع الزمن. عندما تتعارض ذكريات أحدث مع أقدم حول الأمر ذاته، يُظهر السجل كليهما، ويختار أفضل معتقد حالي، ويتيح لك تصحيحه.',
  'beliefLedger.loading': 'جاري تحميل المعتقدات…',
  'beliefLedger.revision.contradicted': 'متناقض',
  'beliefLedger.revision.refined': 'مُكرَّر',
  'beliefLedger.revision.reinforced': 'مُعزَّز',
  'beliefLedger.revision.superseded': 'مُستبدَل',
  'beliefLedger.setTruth': 'تعيين الحقيقة',
  'beliefLedger.setTruthAria': 'تعيين الحقيقة لـ {claim}',
  'beliefLedger.title': 'سجل المعتقدات',
  'memory.tab.beliefs': 'المعتقدات',
};
