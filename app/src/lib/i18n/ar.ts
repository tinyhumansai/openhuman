...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria':
    'نطاق الثقة {range}: متوقع {predicted} بالمائة، فعلي {actual} بالمائة، {n} محلول',
  'predictionLedger.brierHint': 'الأقل أفضل — 0 هو الكمال، 0.25 هو رمي العملة.',
  'predictionLedger.brierLabel': 'درجة Brier',
  'predictionLedger.categoryLabel': 'الفئة (اختياري)',
  'predictionLedger.confidenceLabel': 'الثقة (%)',
  'predictionLedger.curveActual': 'الفعلي',
  'predictionLedger.curveHeading': 'منحنى المعايرة',
  'predictionLedger.curvePredicted': 'متوقع',
  'predictionLedger.decompositionHint':
    'Brier = الموثوقية − التحليل + عدم اليقين. الموثوقية الأقل والتحليل الأعلى أفضل.',
  'predictionLedger.deleteAria': 'حذف التوقع «{statement}»',
  'predictionLedger.deleteButton': 'حذف',
  'predictionLedger.deleteModalMessage': 'حذف هذا التوقع نهائياً؟ لا يمكن التراجع عن هذا.',
  'predictionLedger.deleteModalTitle': 'حذف التوقع',
  'predictionLedger.empty': 'لا توجد توقعات بعد.',
  'predictionLedger.emptyHint': 'سجّل توقعاً مع مستوى ثقتك، ثم احلّه لاحقاً لتبدأ تقييم معايرتك.',
  'predictionLedger.errorPrefix': 'تعذّر تحميل التوقعات:',
  'predictionLedger.intro':
    'سجّل توقعات مع مستوى ثقتك، احلّها صحيحة أو خاطئة، وانظر كم هي معايرة تنبؤاتك بمرور الوقت — درجة Brier ومنحنى المعايرة وما إذا كنت تميل لزيادة أو نقص الثقة.',
  'predictionLedger.loading': 'جاري تحميل التوقعات…',
  'predictionLedger.meanConfidenceLabel': 'متوسط الثقة',
  'predictionLedger.openHeading': 'مفتوحة',
  'predictionLedger.overconfidentLabel': 'مفرط الثقة',
  'predictionLedger.overdueBadge': 'متأخرة',
  'predictionLedger.predictedVsOutcome': 'متوقع {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'الموثوقية',
  'predictionLedger.resolutionLabel': 'التحليل',
  'predictionLedger.resolveAria': 'حلّ «{statement}» كـ {outcome}',
  'predictionLedger.resolveByLabel': 'حلّ بحلول (اختياري)',
  'predictionLedger.resolveFalse': 'لم يتحقق',
  'predictionLedger.resolveTrue': 'تحقق',
  'predictionLedger.resolvedHeading': 'محلولة',
  'predictionLedger.saveFailed': 'تعذّر حفظ التوقع.',
  'predictionLedger.saved': 'تم حفظ التوقع.',
  'predictionLedger.statementLabel': 'التوقع',
  'predictionLedger.statementPlaceholder': 'مثال: النشر يصدر الجمعة',
  'predictionLedger.title': 'معايرة التوقعات',
  'predictionLedger.trendCaption': '{first} → {last} عبر {n} محلولة (الأقل أفضل)',
  'predictionLedger.trendHeading': 'Brier عبر الزمن',
  'predictionLedger.uncertaintyLabel': 'عدم اليقين',
  'predictionLedger.underconfidentLabel': 'ناقص الثقة',
  'predictionLedger.wellCalibratedLabel': 'معايرة جيداً',
};
