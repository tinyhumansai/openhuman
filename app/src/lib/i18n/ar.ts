...
const messages: TranslationMap = {
  ...
  'brain.profile.title': 'الملف المتعلَّم',
  ...
  'brain.profile.rebuild': 'إعادة البناء',
  'brain.profile.rebuilding': 'Rebuilding…',
  'brain.profile.pin': 'تثبيت',
  'brain.profile.unpin': 'إلغاء التثبيت',
  'brain.profile.forget': 'نسيان',
  'brain.profile.pinned': '(pinned)',
  'brain.profile.learningEnabled': 'التعلم الذاتي',
