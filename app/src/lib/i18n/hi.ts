...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthConnected': 'ChatGPT से जुड़ा हुआ',
  ...
  'onboarding.apiKeys.oauthDesktopOnly':
    'ChatGPT साइन-इन केवल डेस्कटॉप ऐप में उपलब्ध है।',
  'onboarding.apiKeys.oauthStartFailed':
    'ChatGPT साइन-इन शुरू नहीं हो सका। पुनः प्रयास करें या API कुंजी का उपयोग करें।',
  ...
  'onboarding.apiKeys.oauthCompleteFailed':
    'ChatGPT साइन-इन पूरा नहीं हुआ। रीडायरेक्ट URL जाँचें और पुनः प्रयास करें।',
