...
const messages: TranslationMap = {
  ...
  'graphCohesion.title': 'ग्राफ़ संसक्ति',
  'graphCohesion.intro':
    'प्रत्येक इकाई के आस-पास का पड़ोस कितनी कसकर जुड़ा हुआ है। दलाल — वे इकाइयाँ जिनके पड़ोसी आपस में जुड़े नहीं हैं — वे अलग-अलग समूहों को एक साथ जोड़ने वाले एकमात्र बिंदु हैं, जिसे आवृत्ति या PageRank क्रमबद्धता प्रकट नहीं कर सकती।',
  'graphCohesion.loading': 'संसक्ति की गणना हो रही है…',
  'graphCohesion.errorPrefix': 'ग्राफ़ लोड नहीं हो सका:',
  'graphCohesion.retry': 'पुनः प्रयास करें',
  'graphCohesion.empty': 'अभी तक कोई ज्ञान ग्राफ़ नहीं है।',
  'graphCohesion.emptyHint':
    'जैसे-जैसे सहायक आपके बारे में जुड़े हुए तथ्य दर्ज करेगा, उनकी क्लस्टरिंग संरचना यहाँ दिखाई देगी।',
  ...
  'graphCohesion.noBrokers': 'अभी तक दो या अधिक कनेक्शन वाली कोई इकाई नहीं है।',
  'graphCohesion.rankedHeading': 'दलाल — सबसे शिथिल पड़ोस',
  'graphCohesion.colRank': '#',
  'graphCohesion.colEntity': 'इकाई',
  'graphCohesion.colCohesion': 'संसक्ति',
  'graphCohesion.colLinks': 'लिंक',
  'graphCohesion.brokerBadge': 'दलाल',
  'graphCohesion.brokerTitle':
    'संरचनात्मक छेद: इस इकाई के पड़ोसी आपस में जुड़े नहीं हैं — यह उनके बीच एकमात्र कड़ी है।',
