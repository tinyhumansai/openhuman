...
const messages: TranslationMap = {
  ...
  'memory.tab.calibration': 'Калибровка',
  'predictionLedger.addButton': 'Добавить прогноз',
  'predictionLedger.addHeading': 'Зарегистрировать прогноз',
  'predictionLedger.baseRateLabel': 'Базовая ставка',
  'predictionLedger.binAria':
    'Диапазон уверенности {range}: предсказано {predicted} процентов, фактически {actual} процентов, {n} разрешённых',
  'predictionLedger.brierHint': 'Ниже — лучше: 0 идеально, 0,25 — подбрасывание монеты.',
  'predictionLedger.brierLabel': 'Оценка Брайера',
  'predictionLedger.categoryLabel': 'Категория (необязательно)',
  'predictionLedger.confidenceLabel': 'Уверенность (%)',
  'predictionLedger.curveActual': 'Фактический',
  'predictionLedger.curveHeading': 'Калибровочная кривая',
  'predictionLedger.curvePredicted': 'Предсказано',
  'predictionLedger.decompositionHint':
    'Brier = надёжность − разрешение + неопределённость. Меньшая надёжность и большее разрешение лучше.',
  'predictionLedger.deleteAria': 'Удалить прогноз «{statement}»',
  'predictionLedger.deleteButton': 'Удалить',
  'predictionLedger.deleteModalMessage': 'Удалить этот прогноз окончательно? Это нельзя отменить.',
  'predictionLedger.deleteModalTitle': 'Удалить прогноз',
  'predictionLedger.empty': 'Пока нет прогнозов.',
  'predictionLedger.emptyHint':
    'Зарегистрируйте прогноз с уровнем уверенности, затем разрешите его позже, чтобы начать оценивать свою калибровку.',
  'predictionLedger.errorPrefix': 'Не удалось загрузить прогнозы:',
  'predictionLedger.intro':
    'Регистрируйте прогнозы с уровнем уверенности, разрешайте их как истинные или ложные, и смотрите, насколько хорошо откалибровано ваше прогнозирование со временем — ваша оценка Брайера, калибровочная кривая, и склонны ли вы к избыточной или недостаточной уверенности.',
  'predictionLedger.loading': 'Загрузка прогнозов…',
  'predictionLedger.meanConfidenceLabel': 'Средняя уверенность',
  'predictionLedger.openHeading': 'Открытые',
  'predictionLedger.overconfidentLabel': 'Самоуверенный',
  'predictionLedger.overdueBadge': 'Просроченные',
  'predictionLedger.predictedVsOutcome': 'Предсказано {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'Надёжность',
  'predictionLedger.resolutionLabel': 'Разрешение',
  'predictionLedger.resolveAria': 'Разрешить «{statement}» как {outcome}',
  'predictionLedger.resolveByLabel': 'Разрешить к (необязательно)',
  'predictionLedger.resolveFalse': 'Не сбылось',
  'predictionLedger.resolveTrue': 'Сбылось',
  'predictionLedger.resolvedHeading': 'Разрешённые',
  'predictionLedger.saveFailed': 'Не удалось сохранить прогноз.',
  'predictionLedger.saved': 'Прогноз сохранён.',
  'predictionLedger.statementLabel': 'Прогноз',
  'predictionLedger.statementPlaceholder': 'напр. Развёртывание уходит в пятницу',
  'predictionLedger.title': 'Калибровка прогнозов',
  'predictionLedger.trendCaption': '{first} → {last} по {n} разрешённым (ниже — лучше)',
  'predictionLedger.trendHeading': 'Brier во времени',
  'predictionLedger.uncertaintyLabel': 'Неопределённость',
  'predictionLedger.underconfidentLabel': 'Недостаточно уверенный',
  'predictionLedger.wellCalibratedLabel': 'Хорошо откалибровано',
};
