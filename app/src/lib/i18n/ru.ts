...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'Уверенность',
  'beliefLedger.confidenceAria': 'Уверенность: {pct}%',
  'beliefLedger.conflictBadge': 'Оспариваемое',
  'beliefLedger.correctionCustomLabel': 'Или введите другое значение',
  'beliefLedger.correctionFailed': 'Не удалось сохранить исправление.',
  'beliefLedger.correctionModalMessage':
    'Сохранить выбранное значение как подтверждённую истину для этого утверждения? Агент будет считать его авторитетным впредь.',
  'beliefLedger.correctionModalTitle': 'Установить правильное значение',
  'beliefLedger.correctionSaved': 'Исправление сохранено.',
  'beliefLedger.correctionSelectAria': 'Выберите правильное значение для {claim}',
  'beliefLedger.currentBelief': 'текущее',
  'beliefLedger.distinctValues': '{n} различных значений',
  'beliefLedger.empty': 'Пока нечего показать из убеждений.',
  'beliefLedger.emptyHint':
    'По мере того как агент узнаёт факты о вас, здесь появятся противоречия и пересмотры со временем.',
  'beliefLedger.errorPrefix': 'Не удалось загрузить убеждения:',
  'beliefLedger.evidence': 'Свидетельство',
  'beliefLedger.evidenceAria': 'Количество свидетельств: {n}',
  'beliefLedger.explain': 'Объяснить это противоречие',
  'beliefLedger.explainAria': 'Объяснить это противоречие для {claim}',
  'beliefLedger.explaining': 'Объясняю…',
  'beliefLedger.explanationHeading': 'Объяснение',
  'beliefLedger.historyHeading': 'История изменений',
  'beliefLedger.intro':
    'Посмотрите, как менялись со временем убеждения агента о вас. Когда более новые воспоминания противоречат более старым о том же, реестр показывает оба, выбирает текущее лучшее убеждение и позволяет вам его исправить.',
  'beliefLedger.loading': 'Загрузка убеждений…',
  'beliefLedger.revision.contradicted': 'опровергнуто',
  'beliefLedger.revision.refined': 'уточнено',
  'beliefLedger.revision.reinforced': 'подкреплено',
  'beliefLedger.revision.superseded': 'заменено',
