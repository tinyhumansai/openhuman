...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthConnected': 'Подключено к ChatGPT',
  ...
  'onboarding.apiKeys.oauthStartFailed':
    'Не удалось запустить вход в ChatGPT. Попробуйте снова или используйте ключ API.',
  ...
  'onboarding.apiKeys.oauthCompleteFailed':
    'Вход в ChatGPT не завершён. Проверьте URL перенаправления и попробуйте снова.',
