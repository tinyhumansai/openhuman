...
const messages: TranslationMap = {
  ...
  'brain.profile.description':
    'Факты, которые агент вывел о вашем стиле работы. Закрепите их, чтобы сохранить; забудьте, чтобы они не вернулись.',
  'brain.profile.loading': 'Загрузка предпочтений…',
  'brain.profile.empty':
    'Пока нет изученных предпочтений. Включите самообучение и продолжайте общаться или перестройте профиль после появления новых данных.',
  'brain.profile.rebuild': 'Пересобрать',
  'brain.profile.rebuilding': 'Перестройка…',
  'brain.profile.pin': 'Закрепить',
  'brain.profile.unpin': 'Открепить',
  'brain.profile.forget': 'Забыть',
  'brain.profile.pinned': '(закреплено)',
  ...
  'brain.profile.class.veto': 'Запреты',
  'brain.profile.class.goal': 'Цели',
  'brain.profile.class.channel': 'Канал',
  'brain.profile.class.other': 'Другое',
  ...
  'privacy.selfLearning': 'Самообучение',
  'privacy.selfLearningLabel': 'Изучать постоянные предпочтения из чатов и подключённых каналов',
  'privacy.selfLearningDesc':
    'При включении OpenHuman может выводить из чатов и подключённых каналов ваш стиль работы и добавлять активные предпочтения в новые сеансы. По умолчанию выключено. Управляйте изученными предпочтениями в Мозг → Профиль.',
