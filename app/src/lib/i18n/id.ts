...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria':
    'Rentang kepercayaan {range}: diprediksi {predicted} persen, aktual {actual} persen, {n} diselesaikan',
  'predictionLedger.brierHint': 'Lebih rendah lebih baik — 0 sempurna, 0,25 adalah lemparan koin.',
  'predictionLedger.brierLabel': 'Skor Brier',
  'predictionLedger.categoryLabel': 'Kategori (opsional)',
  'predictionLedger.confidenceLabel': 'Kepercayaan (%)',
  'predictionLedger.curveActual': 'Aktual',
  'predictionLedger.curveHeading': 'Kurva kalibrasi',
  'predictionLedger.curvePredicted': 'Diprediksi',
  'predictionLedger.decompositionHint':
    'Brier = keandalan − resolusi + ketidakpastian. Keandalan lebih rendah dan resolusi lebih tinggi lebih baik.',
  'predictionLedger.deleteAria': 'Hapus prediksi «{statement}»',
  'predictionLedger.deleteButton': 'Hapus',
  'predictionLedger.deleteModalMessage':
    'Hapus prediksi ini secara permanen? Tindakan ini tidak dapat dibatalkan.',
  'predictionLedger.deleteModalTitle': 'Hapus prediksi',
  'predictionLedger.empty': 'Belum ada prediksi.',
  'predictionLedger.emptyHint':
    'Catat prediksi dengan tingkat kepercayaan Anda, lalu selesaikan nanti untuk mulai menilai kalibrasi Anda.',
  'predictionLedger.errorPrefix': 'Tidak dapat memuat prediksi:',
  'predictionLedger.intro':
    'Catat prediksi dengan tingkat kepercayaan Anda, selesaikan sebagai benar atau salah, dan lihat seberapa baik kalibrasi peramalan Anda seiring waktu — skor Brier Anda, kurva kalibrasi, dan apakah Anda cenderung terlalu atau kurang percaya diri.',
  'predictionLedger.loading': 'Memuat prediksi…',
  'predictionLedger.meanConfidenceLabel': 'Kepercayaan rata-rata',
  'predictionLedger.openHeading': 'Terbuka',
  'predictionLedger.overconfidentLabel': 'Terlalu percaya diri',
  'predictionLedger.overdueBadge': 'Terlambat',
  'predictionLedger.predictedVsOutcome': 'Diprediksi {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'Keandalan',
  'predictionLedger.resolutionLabel': 'Resolusi',
  'predictionLedger.resolveAria': 'Selesaikan «{statement}» sebagai {outcome}',
  'predictionLedger.resolveByLabel': 'Selesaikan sebelum (opsional)',
  'predictionLedger.resolveFalse': 'Tidak terjadi',
  'predictionLedger.resolveTrue': 'Terbukti benar',
  'predictionLedger.resolvedHeading': 'Diselesaikan',
  'predictionLedger.saveFailed': 'Tidak dapat menyimpan prediksi.',
  'predictionLedger.saved': 'Prediksi disimpan.',
  'predictionLedger.statementLabel': 'Prediksi',
  'predictionLedger.statementPlaceholder': 'mis. Deploy rilis Jumat',
  'predictionLedger.title': 'Kalibrasi Prediksi',
  'predictionLedger.trendCaption':
    '{first} → {last} dalam {n} yang diselesaikan (lebih rendah lebih baik)',
  'predictionLedger.trendHeading': 'Brier seiring waktu',
  'predictionLedger.uncertaintyLabel': 'Ketidakpastian',
  'predictionLedger.underconfidentLabel': 'Kurang percaya diri',
  'predictionLedger.wellCalibratedLabel': 'Terkalibrasi baik',
};
