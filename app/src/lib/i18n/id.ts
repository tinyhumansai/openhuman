...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthCallbackHint':
    'Setelah masuk, tempel URL redirect lengkap dari browser Anda (dimulai dengan http://127.0.0.1:1455/).',
  'onboarding.apiKeys.oauthDesktopOnly':
    'Masuk dengan ChatGPT hanya tersedia di aplikasi desktop.',
  'onboarding.apiKeys.oauthStartFailed':
    'Tidak dapat memulai masuk ChatGPT. Coba lagi atau gunakan kunci API.',
  'onboarding.apiKeys.oauthPasteRedirect':
    'Tempel URL redirect dari browser Anda setelah masuk.',
  'onboarding.apiKeys.oauthCompleteFailed':
    'Masuk ChatGPT tidak selesai. Periksa URL redirect dan coba lagi.',
