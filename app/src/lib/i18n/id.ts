...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'Kepercayaan',
  'beliefLedger.confidenceAria': 'Kepercayaan: {pct}%',
  'beliefLedger.conflictBadge': 'Diperdebatkan',
  'beliefLedger.correctionCustomLabel': 'Atau masukkan nilai yang berbeda',
  'beliefLedger.correctionFailed': 'Tidak dapat menyimpan koreksi.',
  'beliefLedger.correctionModalMessage':
    'Simpan nilai yang dipilih sebagai kebenaran yang dikonfirmasi untuk pernyataan ini? Agen akan memperlakukannya sebagai otoritatif ke depan.',
  'beliefLedger.correctionModalTitle': 'Setel nilai yang benar',
  'beliefLedger.correctionSaved': 'Koreksi disimpan.',
  'beliefLedger.correctionSelectAria': 'Pilih nilai yang benar untuk {claim}',
  'beliefLedger.currentBelief': 'saat ini',
  'beliefLedger.distinctValues': '{n} nilai berbeda',
  'beliefLedger.empty': 'Belum ada keyakinan untuk ditampilkan.',
  'beliefLedger.emptyHint':
    'Saat agen mempelajari fakta tentang Anda, kontradiksi dan revisi seiring waktu akan muncul di sini.',
  'beliefLedger.errorPrefix': 'Tidak dapat memuat keyakinan:',
  'beliefLedger.evidence': 'Bukti',
  'beliefLedger.evidenceAria': 'Jumlah bukti: {n}',
  'beliefLedger.explain': 'Jelaskan kontradiksi ini',
  'beliefLedger.explainAria': 'Jelaskan kontradiksi ini untuk {claim}',
  'beliefLedger.explaining': 'Menjelaskan…',
  'beliefLedger.explanationHeading': 'Penjelasan',
  'beliefLedger.historyHeading': 'Riwayat revisi',
  'beliefLedger.intro':
    'Lihat bagaimana apa yang agen yakini tentang Anda berubah seiring waktu. Ketika memori yang lebih baru bertentangan dengan yang lebih lama tentang hal yang sama, buku besar menampilkan keduanya, memilih keyakinan terbaik saat ini, dan memungkinkan Anda untuk mengoreksinya.',
  'beliefLedger.loading': 'Memuat keyakinan…',
  'beliefLedger.revision.contradicted': 'dikontradiksi',
  'beliefLedger.revision.refined': 'disempurnakan',
  'beliefLedger.revision.reinforced': 'diperkuat',
  'beliefLedger.revision.superseded': 'digantikan',
