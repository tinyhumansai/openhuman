...
const ko2: TranslationMap = {
  ...
  'settings.notifications.suppressAllDesc': '포커스 상태와 관계없이 임베디드 앱의 OS 알림 토스트를 모두 차단합니다.',
  ...
  'connections.walletConfigured': '복구 구문을 기반으로 로컬 EVM, BTC, Solana, Tron 신원이 구성되었습니다.',
  ...
  'connections.privacySecurityDesc': '모든 데이터와 자격 증명은 로컬에 저장되며, 데이터 보존 없이 처리됩니다. 정보는 암호화되며 제3자와 공유되지 않습니다.',
  ...
  'mnemonic.wordsInOrder': '단어를 순서대로 기록하고 안전한 곳에 보관하세요. 이 구문은 로컬 암호화 키와 EVM, BTC, Solana, Tron 지갑 신원을 보호합니다.',
  'mnemonic.cannotRecover': '이 구문은 분실 시 복구할 수 없으며 반드시 이 기기에만 안전하게 보관해야 합니다.',
  ...
  'mnemonic.enterPhraseToRestore': '복구 구문을 아래에 입력해 로컬 지갑 신원을 복원하거나, 아무 입력칸에나 전체 구문을 붙여넣으세요. (새 백업은 12단어, 이전 버전의 24단어 구문도 지원합니다.)',
  'mnemonic.words': '단어',
  ...
  'voice.settingsDesc': '단축키를 누르고 있는 동안 받아쓰기하고, 활성 입력 칸에 텍스트를 삽입합니다.',
  'voice.hotkey': '단축키',
  ...
  'voice.addWord': '단어 추가...',
  'voice.sttDisabled': '로컬 STT 모델이 다운로드되어 준비되기 전까지는 음성 받아쓰기를 사용할 수 없습니다.',
