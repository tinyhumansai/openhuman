...
const ko4: TranslationMap = {
  ...
  'settings.autocomplete.completionStyle.acceptedCompletion': '{count} accepted completion stored — used to personalise future suggestions.',
  'settings.autocomplete.completionStyle.acceptedCompletions': '{count} accepted completions stored — used to personalise future suggestions.',
