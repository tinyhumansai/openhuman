...
const ar2: TranslationMap = {
  ...
  'chat.attachment.tooLarge': 'الصورة تتجاوز حد الحجم {max}',
  'chat.attachment.unsupportedType':
    'نوع الملف غير مدعوم. استخدم PNG أو JPEG أو WebP أو GIF أو BMP.',
  'chat.attachment.readFailed': 'تعذرت قراءة الملف',
