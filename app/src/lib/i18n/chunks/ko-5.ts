...
// Korean (한국어) chunk 5/5. Translated from chunks/en-5.ts.
const ko5: TranslationMap = {
  ...
  'settings.mascot.characterDesc': 'OpenHuman의 캐릭터 외형을 선택하세요.',
  'settings.mascot.characterHeading': '캐릭터',
  'settings.mascot.colorDesc': 'OpenHuman의 색상을 선택하세요.',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    '음성 인텔리전스는 전사를 위해 로컬 Whisper 모델이 필요합니다. 로컬 모델 설정에서 다운로드하세요.',
  ...
  'upsell.usageLimit.bodyBudget':
    '주간 한도에 도달했습니다.{reset} 플랜을 업그레이드하거나 크레딧을 충전해 한도를 피하세요.',
  'upsell.usageLimit.bodyRate':
    '10시간 추론 속도 제한에 도달했습니다.{reset} 더 높은 한도를 위해 업그레이드하세요.',
  'upsell.usageLimit.heading': '사용 한도 도달',
  'upsell.usageLimit.notNow': '지금은 아니에요',
  ...
  'walkthrough.tooltip.letsGo': '시작해볼까요!',
  'walkthrough.tooltip.next': '다음 →',
  'walkthrough.tooltip.skip': '둘러보기 건너뛰기',
  'walkthrough.tooltip.stepCounter': '{total} 중 {n}',
  'webhooks.activity.empty': '활동이 없습니다.',
  'webhooks.activity.title': '최근 활동',
  'webhooks.composioHistory.empty': '기록이 없습니다.',
  ...
  'webhooks.tunnels.createFailed': '터널 생성에 실패했습니다',
  'webhooks.tunnels.creating': '생성 중...',
  'webhooks.tunnels.deleteFailed': '터널 삭제에 실패했습니다',
  'webhooks.tunnels.descriptionPlaceholder': '설명 (선택 사항)',
  'webhooks.tunnels.echo': '에코',
  'webhooks.tunnels.empty': '터널이 없습니다.',
  'webhooks.tunnels.enableEcho': '에코 제거',
  'webhooks.tunnels.inactive': '비활성',
  'webhooks.tunnels.namePlaceholder': '터널 이름 (예: telegram-bot)',
  'webhooks.tunnels.newTunnel': '새 터널',
  'webhooks.tunnels.removeEcho': '에코 제거',
  'webhooks.tunnels.title': 'Webhook 터널',
  'webhooks.tunnels.toggleFailed': '에코 전환에 실패했습니다',
