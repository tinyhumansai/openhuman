...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria':
    '신뢰 구간 {range}: 예측 {predicted}퍼센트, 실제 {actual}퍼센트, {n}건 해결',
  'predictionLedger.brierHint': '낮을수록 좋음 — 0이 완벽, 0.25는 동전 던지기.',
  'predictionLedger.brierLabel': 'Brier 점수',
  'predictionLedger.categoryLabel': '범주 (선택)',
  'predictionLedger.confidenceLabel': '신뢰도 (%)',
  'predictionLedger.curveActual': '실제',
  'predictionLedger.curveHeading': '보정 곡선',
  'predictionLedger.curvePredicted': '예측됨',
  'predictionLedger.decompositionHint':
    'Brier = 신뢰도 − 해상도 + 불확실성. 낮은 신뢰도와 높은 해상도가 좋습니다.',
  'predictionLedger.deleteAria': '예측 «{statement}» 삭제',
  'predictionLedger.deleteButton': '삭제',
  'predictionLedger.deleteModalMessage':
    '이 예측을 영구 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.',
  'predictionLedger.deleteModalTitle': '예측 삭제',
  'predictionLedger.empty': '아직 예측이 없습니다.',
  'predictionLedger.emptyHint':
    '확신 수준과 함께 예측을 기록한 다음, 나중에 해결하여 보정 점수 매기기를 시작하세요.',
  'predictionLedger.errorPrefix': '예측을 불러올 수 없습니다:',
  'predictionLedger.intro':
    '확신 수준과 함께 예측을 기록하고, 참 또는 거짓으로 해결한 다음, 시간이 지남에 따라 예측이 얼마나 잘 보정되는지 확인하세요 — Brier 점수, 보정 곡선, 그리고 과신 또는 저신 경향이 있는지.',
  'predictionLedger.loading': '예측 불러오는 중…',
  'predictionLedger.meanConfidenceLabel': '평균 신뢰도',
  'predictionLedger.openHeading': '미해결',
  'predictionLedger.overconfidentLabel': '과신',
  'predictionLedger.overdueBadge': '기한 초과',
  'predictionLedger.predictedVsOutcome': '예측 {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': '신뢰도',
  'predictionLedger.resolutionLabel': '해상도',
  'predictionLedger.resolveAria': '«{statement}»을(를) {outcome}(으)로 해결',
  'predictionLedger.resolveByLabel': '해결 기한 (선택)',
  'predictionLedger.resolveFalse': '실현되지 않음',
  'predictionLedger.resolveTrue': '실현됨',
  'predictionLedger.resolvedHeading': '해결됨',
  'predictionLedger.saveFailed': '예측을 저장할 수 없습니다.',
  'predictionLedger.saved': '예측이 저장되었습니다.',
  'predictionLedger.statementLabel': '예측',
  'predictionLedger.statementPlaceholder': '예: 배포는 금요일에 출시됩니다',
  'predictionLedger.title': '예측 보정',
  'predictionLedger.trendCaption': '{n}건 해결에서 {first} → {last} (낮을수록 좋음)',
  'predictionLedger.trendHeading': '시간에 따른 Brier',
  'predictionLedger.uncertaintyLabel': '불확실성',
  'predictionLedger.underconfidentLabel': '저신',
  'predictionLedger.wellCalibratedLabel': '잘 보정됨',
};
