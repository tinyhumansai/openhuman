...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': '신뢰도',
  'beliefLedger.confidenceAria': '신뢰도: {pct}%',
  'beliefLedger.conflictBadge': '논쟁 중',
  'beliefLedger.correctionCustomLabel': '또는 다른 값을 입력하세요',
  'beliefLedger.correctionFailed': '수정을 저장할 수 없습니다.',
  'beliefLedger.correctionModalMessage':
    '선택한 값을 이 주장에 대한 확인된 진실로 저장하시겠습니까? 에이전트는 앞으로 이를 권위 있는 것으로 취급합니다.',
  'beliefLedger.correctionModalTitle': '올바른 값 설정',
  'beliefLedger.correctionSaved': '수정이 저장되었습니다.',
  'beliefLedger.correctionSelectAria': '{claim}에 대한 올바른 값을 선택하세요',
  'beliefLedger.currentBelief': '현재',
  'beliefLedger.distinctValues': '{n}개 고유 값',
  'beliefLedger.empty': '표시할 믿음이 아직 없습니다.',
  'beliefLedger.emptyHint':
    '에이전트가 사용자에 대해 사실을 학습함에 따라, 시간이 지나면서 모순과 수정이 여기에 나타납니다.',
  'beliefLedger.errorPrefix': '믿음을 불러올 수 없습니다:',
  'beliefLedger.evidence': '증거',
  'beliefLedger.evidenceAria': '증거 개수: {n}',
  'beliefLedger.explain': '이 모순 설명',
  'beliefLedger.explainAria': '{claim}에 대한 이 모순 설명',
  'beliefLedger.explaining': '설명 중…',
  'beliefLedger.explanationHeading': '설명',
  'beliefLedger.historyHeading': '수정 이력',
  'beliefLedger.intro':
    '에이전트가 사용자에 대해 믿는 것이 시간이 지남에 따라 어떻게 변했는지 확인하세요. 더 새로운 기억이 같은 것에 대한 더 오래된 기억과 모순될 때, 원장은 둘 다 표시하고, 현재 최선의 믿음을 선택하며, 수정할 수 있게 합니다.',
  'beliefLedger.loading': '믿음 불러오는 중…',
  'beliefLedger.revision.contradicted': '반박됨',
  'beliefLedger.revision.refined': '정제됨',
  'beliefLedger.revision.reinforced': '강화됨',
  'beliefLedger.revision.superseded': '대체됨',
