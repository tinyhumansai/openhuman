...
const messages: TranslationMap = {
  ...
  'walkthrough.desc.start': '권장 설정 경로로 시작하세요',
  ...
  'walkthrough.card.actionAria': '계속 {label}',
  ...
  'walkthrough.review.description':
    '검토한 설정 영역의 요약입니다. 나중에 설정에서 연결하거나 변경할 수 있습니다.',
  'walkthrough.review.skipped': '설정을 건너뛰었습니다. 설정에서 언제든지 구성할 수 있습니다.',
  'walkthrough.review.empty': '아직 검토한 항목이 없습니다.',
  'walkthrough.done.title': '모든 준비가 완료되었습니다!',
  'walkthrough.done.description':
    '도우미가 도움을 줄 준비가 되었습니다. 나중에 설정에서 도구를 연결하고 자동화를 켤 수 있습니다.',
