...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'Confiance',
  'beliefLedger.confidenceAria': 'Confiance : {pct}%',
  'beliefLedger.conflictBadge': 'Contesté',
  'beliefLedger.correctionCustomLabel': 'Ou saisissez une valeur différente',
  'beliefLedger.correctionFailed': "Impossible d'enregistrer la correction.",
  'beliefLedger.correctionModalMessage':
    "Enregistrer la valeur sélectionnée comme vérité confirmée pour cette affirmation ? L'agent la traitera comme faisant autorité à l'avenir.",
  'beliefLedger.correctionModalTitle': 'Définir la valeur correcte',
  'beliefLedger.correctionSaved': 'Correction enregistrée.',
  'beliefLedger.correctionSelectAria': 'Choisissez la valeur correcte pour {claim}',
  'beliefLedger.currentBelief': 'actuel',
  'beliefLedger.distinctValues': '{n} valeurs distinctes',
  'beliefLedger.empty': "Aucune croyance à afficher pour l'instant.",
  'beliefLedger.emptyHint':
    "À mesure que l'agent apprend des faits à votre sujet, les contradictions et révisions au fil du temps apparaîtront ici.",
  'beliefLedger.errorPrefix': 'Impossible de charger les croyances :',
  'beliefLedger.evidence': 'Preuve',
  'beliefLedger.evidenceAria': 'Nombre de preuves : {n}',
  'beliefLedger.explain': 'Expliquer cette contradiction',
  'beliefLedger.explainAria': 'Expliquer cette contradiction pour {claim}',
  'beliefLedger.explaining': 'Explication…',
  'beliefLedger.explanationHeading': 'Explication',
  'beliefLedger.historyHeading': 'Historique des révisions',
  'beliefLedger.intro':
    "Voyez comment ce que l'agent croit à votre sujet a changé au fil du temps. Quand des souvenirs plus récents contredisent les plus anciens sur la même chose, le registre révèle les deux, choisit la meilleure croyance actuelle, et vous laisse la corriger.",
  'beliefLedger.loading': 'Chargement des croyances…',
  'beliefLedger.revision.contradicted': 'contredit',
  'beliefLedger.revision.refined': 'affiné',
  'beliefLedger.revision.reinforced': 'renforcé',
  'beliefLedger.revision.superseded': 'remplacé',
