...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria':
    'Plage de confiance {range} : prédit {predicted} pour cent, réel {actual} pour cent, {n} résolus',
  'predictionLedger.brierHint':
    'Plus bas est mieux — 0 est parfait, 0,25 est un tirage à pile ou face.',
  'predictionLedger.brierLabel': 'Score de Brier',
  'predictionLedger.categoryLabel': 'Catégorie (facultative)',
  'predictionLedger.confidenceLabel': 'Confiance (%)',
  'predictionLedger.curveActual': 'Réel',
  'predictionLedger.curveHeading': 'Courbe de calibration',
  'predictionLedger.curvePredicted': 'Prédit',
  'predictionLedger.decompositionHint':
    'Brier = fiabilité − résolution + incertitude. Une fiabilité plus faible et une résolution plus élevée sont meilleures.',
  'predictionLedger.deleteAria': 'Supprimer la prédiction « {statement} »',
  'predictionLedger.deleteButton': 'Supprimer',
  'predictionLedger.deleteModalMessage':
    'Supprimer définitivement cette prédiction ? Cette action est irréversible.',
  'predictionLedger.deleteModalTitle': 'Supprimer la prédiction',
  'predictionLedger.empty': "Aucune prédiction pour l'instant.",
  'predictionLedger.emptyHint':
    'Enregistrez une prédiction avec votre niveau de confiance, puis résolvez-la plus tard pour commencer à évaluer votre calibration.',
  'predictionLedger.errorPrefix': 'Impossible de charger les prédictions :',
  'predictionLedger.intro':
    'Enregistrez vos prédictions avec votre niveau de confiance, résolvez-les vrai ou faux, et voyez la qualité de votre calibration au fil du temps — votre score de Brier, courbe de calibration, et si vous tendez à être sur- ou sous-confiant.',
  'predictionLedger.loading': 'Chargement des prédictions…',
  'predictionLedger.meanConfidenceLabel': 'Confiance moyenne',
  'predictionLedger.openHeading': 'Ouvertes',
  'predictionLedger.overconfidentLabel': 'Surconfiant',
  'predictionLedger.overdueBadge': 'En retard',
  'predictionLedger.predictedVsOutcome': 'Prédit {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'Fiabilité',
  'predictionLedger.resolutionLabel': 'Résolution',
  'predictionLedger.resolveAria': 'Résoudre « {statement} » comme {outcome}',
  'predictionLedger.resolveByLabel': 'Résoudre avant (facultatif)',
  'predictionLedger.resolveFalse': 'Non réalisé',
  'predictionLedger.resolveTrue': "S'est réalisé",
  'predictionLedger.resolvedHeading': 'Résolues',
  'predictionLedger.saveFailed': "Impossible d'enregistrer la prédiction.",
  'predictionLedger.saved': 'Prédiction enregistrée.',
  'predictionLedger.statementLabel': 'Prédiction',
  'predictionLedger.statementPlaceholder': 'p. ex. Le déploiement part vendredi',
  'predictionLedger.title': 'Calibration des prédictions',
  'predictionLedger.trendCaption': '{first} → {last} sur {n} résolus (plus bas est mieux)',
  'predictionLedger.trendHeading': 'Brier au fil du temps',
  'predictionLedger.uncertaintyLabel': 'Incertitude',
  'predictionLedger.underconfidentLabel': 'Sous-confiant',
  'predictionLedger.wellCalibratedLabel': 'Bien calibré',
};
