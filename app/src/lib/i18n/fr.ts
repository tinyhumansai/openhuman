...
const messages: TranslationMap = {
  ...
  'connectionPath.intro': 'Retracez la plus courte chaîne de relations reliant deux entités — comment le graphe les connecte, même à travers plusieurs sauts.',
  ...
  'connectionPath.emptyHint': 'Une fois que l\'assistant aura enregistré des faits liés, vous pourrez retracer les connexions ici.',
