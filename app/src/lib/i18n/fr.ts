...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthConnected': 'Connecté à ChatGPT',
  'onboarding.apiKeys.openaiOauthCallbackHint':
    'Après la connexion, collez l'URL de redirection complète de votre navigateur (commence par http://127.0.0.1:1455/).',
  'onboarding.apiKeys.oauthDesktopOnly':
    'La connexion ChatGPT est uniquement disponible dans l'application de bureau.',
  'onboarding.apiKeys.oauthStartFailed':
    'Impossible de démarrer la connexion ChatGPT. Réessayez ou utilisez une clé API.',
  ...
  'onboarding.apiKeys.oauthCompleteFailed':
    'La connexion ChatGPT n'a pas abouti. Vérifiez l'URL de redirection et réessayez.',
