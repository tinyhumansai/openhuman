...
const messages: TranslationMap = {
  ...
  'predictionLedger.binAria': '置信区间 {range}:预测 {predicted}%、实际 {actual}%、已裁决 {n} 项',
  'predictionLedger.brierHint': '越低越好——0 为完美,0.25 相当于抛硬币。',
  'predictionLedger.brierLabel': 'Brier 分数',
  'predictionLedger.categoryLabel': '类别(可选)',
  'predictionLedger.confidenceLabel': '置信度 (%)',
  'predictionLedger.curveActual': '实际',
  'predictionLedger.curveHeading': '校准曲线',
  'predictionLedger.curvePredicted': '预测',
  'predictionLedger.decompositionHint':
    'Brier = 可靠性 − 分辨率 + 不确定性。可靠性更低、分辨率更高更佳。',
  'predictionLedger.deleteAria': '删除预测「{statement}」',
  'predictionLedger.deleteButton': '删除',
  'predictionLedger.deleteModalMessage': '永久删除此预测吗?此操作无法撤销。',
  'predictionLedger.deleteModalTitle': '删除预测',
  'predictionLedger.empty': '暂无预测。',
  'predictionLedger.emptyHint': '记录预测并附上你的置信度,稍后裁决以开始评分你的校准度。',
  'predictionLedger.errorPrefix': '无法加载预测:',
  'predictionLedger.intro':
    '记录预测并附上你的置信度,将其裁决为真或假,然后观察你的预测随时间的校准程度——你的 Brier 分数、校准曲线,以及你是否倾向于过度或不足自信。',
  'predictionLedger.loading': '正在加载预测…',
  'predictionLedger.meanConfidenceLabel': '平均置信度',
  'predictionLedger.openHeading': '未裁决',
  'predictionLedger.overconfidentLabel': '过度自信',
  'predictionLedger.overdueBadge': '已逾期',
  'predictionLedger.predictedVsOutcome': '预测 {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': '可靠性',
  'predictionLedger.resolutionLabel': '分辨率',
  'predictionLedger.resolveAria': '将「{statement}」裁决为 {outcome}',
  'predictionLedger.resolveByLabel': '裁决期限(可选)',
  'predictionLedger.resolveFalse': '未实现',
  'predictionLedger.resolveTrue': '已实现',
  'predictionLedger.resolvedHeading': '已裁决',
  'predictionLedger.saveFailed': '无法保存预测。',
  'predictionLedger.saved': '预测已保存。',
  'predictionLedger.statementLabel': '预测',
  'predictionLedger.statementPlaceholder': '例如:部署在周五发布',
  'predictionLedger.title': '预测校准',
  'predictionLedger.trendCaption': '在 {n} 项裁决中 {first} → {last}(越低越好)',
  'predictionLedger.trendHeading': 'Brier 随时间变化',
  'predictionLedger.uncertaintyLabel': '不确定性',
  'predictionLedger.underconfidentLabel': '信心不足',
  'predictionLedger.wellCalibratedLabel': '校准良好',
};
