...
const messages: TranslationMap = {
  ...
  'settings.agentbox.intro': 'AgentBox 市场适配器的只读状态。模式和 GMI MaaS 提供商在核心启动时由环境变量设置。',
  ...
  'settings.agentbox.notConfigured': '未配置。请设置 GMI_MAAS_BASE_URL、GMI_MAAS_API_KEY 和 GMI_MODELS 环境变量。',
