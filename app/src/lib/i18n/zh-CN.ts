...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthConnected': '已连接 ChatGPT',
  ...
  'onboarding.apiKeys.oauthStartFailed':
    '无法启动 ChatGPT 登录。请重试或使用 API 密钥。',
  'onboarding.apiKeys.oauthPasteRedirect': '登录后，请从浏览器粘贴重定向 URL。',
  'onboarding.apiKeys.oauthCompleteFailed':
    'ChatGPT 登录未完成。请检查重定向 URL 并重试。',
