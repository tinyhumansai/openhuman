...
const messages: TranslationMap = {
  ...
  'graphBridges.articulationBadge': '割点',
  'graphBridges.articulationTitle': '移除该实体会使图断开:经过它的聚类彼此间会失去链接。',
  'graphBridges.articulationsHeading': '关节实体',
  'graphBridges.bridgesHeading': '桥关系',
  'graphBridges.colEntity': '实体',
  'graphBridges.colLinks': '链接',
  'graphBridges.colRank': '#',
  'graphBridges.empty': '暂无知识图。',
  'graphBridges.emptyHint': '随着助手记录有关你的相互关联的事实,结构性的单点故障将在此呈现。',
  'graphBridges.errorPrefix': '无法加载图:',
  'graphBridges.intro':
    '关节点是那些一旦移除就会让记忆图断开的实体。桥是把两半连在一起的唯一关系。丢掉一座桥,大片上下文就会归于沉默——这是度数和 PageRank 都揭示不了的结构性脆弱。',
  'graphBridges.loading': '正在计算结构切口…',
  'graphBridges.metricArticulations': '关节点',
  'graphBridges.metricConnections': '连接',
  'graphBridges.metricEntities': '实体',
  'graphBridges.namespaceAll': '所有命名空间',
  'graphBridges.namespaceLabel': '命名空间',
  'graphBridges.noBridges': '没有桥——每个关系都处于至少一个循环中。',
  'graphBridges.noFragiles': '没有结构性单点故障——每条链接都处于至少一个循环中。',
  'graphBridges.retry': '重试',
  'graphBridges.summaryCaption': '{bridges} 座桥 · {components} 个组件',
  'graphBridges.summaryCaptionOne': '{bridges} 座桥 · 单一组件',
  'graphBridges.summaryCaptionOneBridge': '1 座桥 · {components} 个组件',
  'graphBridges.summaryCaptionOneBridgeOneComponent': '1 座桥 · 单一组件',
  'graphBridges.title': '图的桥',
