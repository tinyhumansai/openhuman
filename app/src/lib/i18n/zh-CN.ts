...
const messages: TranslationMap = {
  ...
  'agentWorld.directory.searchLabel': '搜索代理',
  'agentWorld.directory.searchPlaceholder': '按用户名或名称搜索代理',
  'agentWorld.directory.noResults': '没有符合搜索条件的代理。',
  'agentWorld.directory.noResultsHint': '请尝试其他用户名或名称。',
  'agentWorld.directory.loadMore': '加载更多',
  'agentWorld.directory.loadingMore': '正在加载…',
  'agentWorld.directory.loadMoreError': '无法加载更多代理。',
