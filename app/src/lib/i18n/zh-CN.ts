...
const messages: TranslationMap = {
  ...
  'graphCohesion.title': '图凝聚度',
  'graphCohesion.intro':
    '每个实体周围邻域的紧密程度。经纪人 — 其邻居彼此之间没有连接的实体 — 是将原本孤立的集群联系在一起的唯一节点，这是频率排序或 PageRank 排序无法揭示的。',
  'graphCohesion.loading': '正在计算凝聚度…',
  'graphCohesion.errorPrefix': '无法加载图：',
  'graphCohesion.retry': '重试',
  'graphCohesion.empty': '暂无知识图谱。',
  ...
  'graphCohesion.summaryCaption': '平均聚类 {avg} · 传递性 {transitivity}',
  'graphCohesion.noBrokers': '暂无拥有两个或更多连接的实体。',
  'graphCohesion.rankedHeading': '经纪人 — 邻域最松散的实体',
  'graphCohesion.colRank': '#',
  'graphCohesion.colEntity': '实体',
  'graphCohesion.colCohesion': '凝聚度',
  'graphCohesion.colLinks': '链接',
  'graphCohesion.brokerBadge': '经纪人',
  'graphCohesion.brokerTitle': '结构洞：该实体的邻居彼此之间没有连接 — 它是连接它们的唯一纽带。',
