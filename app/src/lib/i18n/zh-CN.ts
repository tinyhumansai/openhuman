...
const messages: TranslationMap = {
  ...
  'graphReach.centerTitle': '其聚类的中心——以最少的可能跳数到达每个相连实体(离心率等于半径)。',
  'graphReach.colEccentricity': '离心率',
  'graphReach.colEntity': '实体',
  'graphReach.colLinks': '链接',
  'graphReach.colRank': '#',
  'graphReach.empty': '暂无知识图。',
  'graphReach.emptyHint': '随着助手记录有关你的相互关联的事实,你记忆的形状和中心将在此呈现。',
  'graphReach.errorPrefix': '无法加载图:',
  'graphReach.intro':
    '离心率衡量一个实体距其能到达的一切有多远——它最长的最短路径。直径是这种间距中最大的,半径是最小的,中心是以最少跳数到达整个聚类的实体。度数和 PageRank 都揭示不了中心。',
  'graphReach.loading': '正在计算到达范围…',
  ...
  'graphReach.rankedHeading': '最具中心性的实体',
  'graphReach.retry': '重试',
  'graphReach.summaryCaption': '{components} 个组件 · 最大的包含 {giant} 个',
  'graphReach.summaryCaptionOne': '1 个组件 · {giant} 个实体',
  'graphReach.summaryCaptionOneAndOne': '1 个组件 · 1 个实体',
  'graphReach.title': '图的到达范围',
