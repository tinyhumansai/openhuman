...
const messages: TranslationMap = {
  ...
  'brain.header.profile': '智能体已学到的偏好，以及会注入每次回复的内容。',
  ...
  'brain.profile.title': '已学习画像',
  'brain.profile.description': '智能体推断出的工作偏好。固定可保留；忘记可阻止再次出现。',
  'brain.profile.loading': '正在加载偏好…',
  'brain.profile.empty': '还没有学到的偏好。打开自我学习并继续对话，或在有新证据后重建。',
  'brain.profile.rebuild': '重建',
  'brain.profile.rebuilding': '正在重建…',
  'brain.profile.pin': '固定偏好',
  'brain.profile.unpin': '取消固定',
  'brain.profile.forget': '忘记偏好',
  'brain.profile.pinned': '（已固定）',
  'brain.profile.learningEnabled': '自我学习',
  ...
  'brain.profile.class.veto': '禁止项',
  'brain.profile.class.goal': '目标',
  'brain.profile.class.channel': '渠道',
  'brain.profile.class.other': '其他',
