...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': '置信度',
  'beliefLedger.confidenceAria': '置信度:{pct}%',
  'beliefLedger.conflictBadge': '有争议',
  'beliefLedger.correctionCustomLabel': '或输入其他值',
  'beliefLedger.correctionFailed': '无法保存更正。',
  'beliefLedger.correctionModalMessage':
    '将所选值保存为该断言的已确认事实吗?智能体此后将其视为权威。',
  'beliefLedger.correctionModalTitle': '设置正确值',
  'beliefLedger.correctionSaved': '更正已保存。',
  'beliefLedger.correctionSelectAria': '为 {claim} 选择正确的值',
  'beliefLedger.currentBelief': '当前',
  'beliefLedger.distinctValues': '{n} 个不同值',
  'beliefLedger.empty': '暂无信念可显示。',
  'beliefLedger.emptyHint': '随着智能体逐步了解你的相关事实,随时间推移产生的矛盾和修订将在此显现。',
  'beliefLedger.errorPrefix': '无法加载信念:',
  'beliefLedger.evidence': '证据',
  'beliefLedger.evidenceAria': '证据数:{n}',
  'beliefLedger.explain': '解释这一矛盾',
  'beliefLedger.explainAria': '解释 {claim} 的这一矛盾',
  'beliefLedger.explaining': '正在解释…',
  'beliefLedger.explanationHeading': '解释',
  'beliefLedger.historyHeading': '修订历史',
  'beliefLedger.intro':
    '查看智能体对你的信念如何随时间改变。当较新的记忆与旧记忆就同一事项相冲突时,账本同时呈现两者、选出当前最佳信念,并允许你进行更正。',
  'beliefLedger.loading': '正在加载信念…',
  'beliefLedger.revision.contradicted': '已被反驳',
  'beliefLedger.revision.refined': '已细化',
  'beliefLedger.revision.reinforced': '已强化',
  'beliefLedger.revision.superseded': '已被取代',
