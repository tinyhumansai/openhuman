...
const messages: TranslationMap = {
  ...
  'memory.tab.reach': '可达性',
  'graphReach.title': '图的可达性',
  'graphReach.intro':
    '离心率衡量一个实体与其所能到达的一切之间的距离——其最长的最短路径。直径是最大的此类间距，半径是最小的，中心则是以最少跳数到达整个集群的实体。度数和 PageRank 均无法揭示中心。',
  'graphReach.loading': '正在计算可达性…',
  'graphReach.errorPrefix': '无法加载图：',
  'graphReach.retry': '重试',
  'graphReach.empty': '尚无知识图谱。',
  'graphReach.emptyHint': '当助手记录关于您的关联事实后，您的记忆形态与中心将在此显示。',
  'graphReach.namespaceLabel': '命名空间',
  'graphReach.namespaceAll': '所有命名空间',
  'graphReach.metricEntities': '实体',
  'graphReach.metricDiameter': '直径',
  'graphReach.metricRadius': '半径',
  'graphReach.summaryCaption': '{components} 个连通分量 · 最大的包含 {giant}',
  'graphReach.summaryCaptionOne': '1 个连通分量 · {giant} 个实体',
  'graphReach.summaryCaptionOneAndOne': '1 个连通分量 · 1 个实体',
  'graphReach.rankedHeading': '最核心的实体',
  'graphReach.colRank': '#',
  'graphReach.colEntity': '实体',
  'graphReach.colEccentricity': '离心率',
  'graphReach.colLinks': '连接数',
  'graphReach.centerBadge': '中心',
  'graphReach.centerTitle': '其集群的中心——以最少跳数到达所有相连实体（离心率等于半径）。',
};
