...
const messages: TranslationMap = {
  ...
  'documentProvenance.colDocument': '文档',
  'documentProvenance.colEntities': '实体',
  'documentProvenance.colExclusive': '仅',
  'documentProvenance.colRank': '#',
  'documentProvenance.colRelations': '关系',
  'documentProvenance.corroboratesWith': '印证于',
  'documentProvenance.docsHeading': '按文档的足迹',
  'documentProvenance.empty': '暂无知识图。',
  'documentProvenance.emptyHint': '随着助手记录来自你文档的关系,它们的来源足迹将在此显现。',
  'documentProvenance.errorPrefix': '无法加载图:',
  'documentProvenance.intro':
    '其他每个透镜分析图的(主体、谓词、客体)三元组一侧。本透镜转向另一侧——每条关系的来源文档——以揭示哪些文档是承载性的(承载着无其他来源证明的知识)、哪些彼此印证,以及你的记忆有多少来自单一来源。',
  'documentProvenance.loadBearingBadge': '承载性',
  'documentProvenance.loadBearingTitle':
    '此文档证明至少一条没有任何其他来源同时证明的关系——移除它将丢失该知识。',
  'documentProvenance.loading': '正在计算来源足迹…',
  'documentProvenance.metricCoverage': '来源覆盖',
  'documentProvenance.metricDocuments': '文档',
  'documentProvenance.metricSingleSource': '单源占比',
  'documentProvenance.namespaceAll': '所有命名空间',
  'documentProvenance.namespaceLabel': '命名空间',
  'documentProvenance.noDocuments': '暂无文档关联到任何关系。',
  'documentProvenance.noOverlap': '暂无文档相互印证——每个来源都承载着互不相交的实体集合。',
  'documentProvenance.pairsHeading': '重叠最高的配对',
  'documentProvenance.retry': '重试',
  'documentProvenance.title': '文档来源',
  'documentProvenance.unsourcedCaption': '{count} 条没有来源的关系',
  'documentProvenance.unsourcedCaptionOne': '1 个没有来源的关系',
