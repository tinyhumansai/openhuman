...
const messages: TranslationMap = {
  ...
  'evidenceTrust.colDegree': '关系',
  'evidenceTrust.colEntity': '实体',
  'evidenceTrust.colRank': '#',
  'evidenceTrust.colTrust': '信任商',
  'evidenceTrust.degradedHint':
    '目前每条关系都带 evidenceCount = 1,因此信任商坍缩为常数。本透镜需要多样化的印证值,才能将「多产-单薄」与「沉静-稳固」区分开来。',
  'evidenceTrust.degradedTitle': '证据信号稀疏——填充 evidenceCount 以解锁此透镜。',
  'evidenceTrust.empty': '暂无知识图。',
  'evidenceTrust.emptyHint': '随着助手记录带 evidenceCount 的关于你的关系,信任画像将在此显现。',
  'evidenceTrust.entitiesHeading': '信任商排名',
  'evidenceTrust.errorPrefix': '无法加载图:',
  'evidenceTrust.evidenceLabel': '证 {n}',
  'evidenceTrust.intro':
    '实体信任商 = 它所参与的每条关系的平均证据。证据基尼衡量证据在实体间的集中不均匀程度。印证不足工作清单标记证据低于由图导出的阈值的关系——策展人的审查队列。',
  'evidenceTrust.loading': '正在计算信任画像…',
  'evidenceTrust.metricEntities': '加权实体',
  'evidenceTrust.metricEvidence': '总证据',
  'evidenceTrust.metricGini': '证据基尼',
  'evidenceTrust.namespaceAll': '所有命名空间',
  'evidenceTrust.namespaceLabel': '命名空间',
  'evidenceTrust.noWorklist': '没有印证不足的关系——每条断言都达到证据阈值。',
  'evidenceTrust.pointsTo': '指向',
  'evidenceTrust.predicatesHeading': '谓词可靠性指数',
  'evidenceTrust.retry': '重试',
  'evidenceTrust.summaryCaption': '{relations} 条不同关系 · 印证不足阈值 {threshold}',
  'evidenceTrust.title': '证据加权信任',
  'evidenceTrust.worklistHeading': '印证不足工作清单',
