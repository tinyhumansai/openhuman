...
const messages: TranslationMap = {
  ...
  'brain.profile.description':
    'Fakty wywnioskowane przez agenta na temat Twojego sposobu pracy. Przypnij je, aby je zachować; zapomnij, aby nie wróciły.',
  'brain.profile.loading': 'Ładowanie preferencji…',
  'brain.profile.empty':
    'Nie ma jeszcze wyuczonych preferencji. Włącz samouczenie i rozmawiaj dalej albo przebuduj profil po pojawieniu się nowych danych.',
  'brain.profile.rebuild': 'Przebuduj',
  'brain.profile.rebuilding': 'Przebudowywanie…',
  'brain.profile.pin': 'Przypnij',
  'brain.profile.unpin': 'Odepnij',
  'brain.profile.forget': 'Zapomnij',
  'brain.profile.pinned': '(przypięta)',
  ...
  'brain.profile.class.veto': 'Weta',
  'brain.profile.class.goal': 'Cele',
  'brain.profile.class.channel': 'Kanał',
  'brain.profile.class.other': 'Inne',
  ...
  'privacy.selfLearning': 'Samouczenie',
  'privacy.selfLearningLabel': 'Ucz się stałych preferencji z czatów i połączonych kanałów',
  'privacy.selfLearningDesc':
    'Po włączeniu OpenHuman może wywnioskować z czatów i połączonych kanałów, jak lubisz pracować, oraz wstrzykiwać aktywne preferencje do nowych sesji. Domyślnie wyłączone. Zarządzaj wyuczonymi preferencjami w Mózg → Profil.',
