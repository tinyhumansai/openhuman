...
const messages: TranslationMap = {
  ...
  'memory.tab.calibration': 'Kalibracja',
  'predictionLedger.addButton': 'Dodaj prognozę',
  'predictionLedger.addHeading': 'Zarejestruj prognozę',
  'predictionLedger.baseRateLabel': 'Stopa bazowa',
  'predictionLedger.binAria':
    'Przedział pewności {range}: prognozowane {predicted} procent, rzeczywiste {actual} procent, {n} rozstrzygniętych',
  'predictionLedger.brierHint': 'Niżej jest lepiej — 0 to ideał, 0,25 to rzut monetą.',
  'predictionLedger.brierLabel': 'Wynik Briera',
  'predictionLedger.categoryLabel': 'Kategoria (opcjonalna)',
  'predictionLedger.confidenceLabel': 'Pewność (%)',
  'predictionLedger.curveActual': 'Rzeczywiste',
  'predictionLedger.curveHeading': 'Krzywa kalibracji',
  'predictionLedger.curvePredicted': 'Prognozowane',
  'predictionLedger.decompositionHint':
    'Brier = niezawodność − rozdzielczość + niepewność. Niższa niezawodność i wyższa rozdzielczość są lepsze.',
  'predictionLedger.deleteAria': 'Usuń prognozę «{statement}»',
  'predictionLedger.deleteButton': 'Usuń',
  'predictionLedger.deleteModalMessage':
    'Usunąć tę prognozę na stałe? Tej operacji nie można cofnąć.',
  'predictionLedger.deleteModalTitle': 'Usuń prognozę',
  'predictionLedger.empty': 'Jeszcze brak prognoz.',
  'predictionLedger.emptyHint':
    'Zarejestruj prognozę z poziomem pewności, a potem rozstrzygnij ją później, aby zacząć oceniać swoją kalibrację.',
  'predictionLedger.errorPrefix': 'Nie udało się załadować prognoz:',
  'predictionLedger.intro':
    'Rejestruj prognozy z poziomem pewności, rozstrzygaj je jako prawdziwe lub fałszywe i obserwuj, jak dobrze skalibrowana jest twoja prognoza w czasie — twój wynik Briera, krzywa kalibracji oraz czy masz tendencję do bycia zbyt lub niedostatecznie pewnym.',
  'predictionLedger.loading': 'Ładowanie prognoz…',
  'predictionLedger.meanConfidenceLabel': 'Średnia pewność',
  'predictionLedger.openHeading': 'Otwarte',
  'predictionLedger.overconfidentLabel': 'Nadmiernie pewny',
  'predictionLedger.overdueBadge': 'Zaległe',
  'predictionLedger.predictedVsOutcome': 'Prognozowane {predicted}% → {outcome}',
  'predictionLedger.reliabilityLabel': 'Niezawodność',
  'predictionLedger.resolutionLabel': 'Rozdzielczość',
  'predictionLedger.resolveAria': 'Rozstrzygnij «{statement}» jako {outcome}',
  'predictionLedger.resolveByLabel': 'Rozstrzygnij do (opcjonalne)',
  'predictionLedger.resolveFalse': 'Nie spełniło się',
  'predictionLedger.resolveTrue': 'Spełniło się',
  'predictionLedger.resolvedHeading': 'Rozstrzygnięte',
  'predictionLedger.saveFailed': 'Nie udało się zapisać prognozy.',
  'predictionLedger.saved': 'Prognoza zapisana.',
  'predictionLedger.statementLabel': 'Prognoza',
  'predictionLedger.statementPlaceholder': 'np. Wdrożenie idzie w piątek',
  'predictionLedger.title': 'Kalibracja prognoz',
  'predictionLedger.trendCaption': '{first} → {last} na {n} rozstrzygniętych (niżej jest lepiej)',
  'predictionLedger.trendHeading': 'Brier w czasie',
  'predictionLedger.uncertaintyLabel': 'Niepewność',
  'predictionLedger.underconfidentLabel': 'Niedostatecznie pewny',
  'predictionLedger.wellCalibratedLabel': 'Dobrze skalibrowane',
};
