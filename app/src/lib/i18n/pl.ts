...
const messages: TranslationMap = {
  ...
  'onboarding.apiKeys.openaiOauthConnect': 'Zaloguj się przez ChatGPT',
  'onboarding.apiKeys.openaiOauthConnected': 'Połączono z ChatGPT',
  'onboarding.apiKeys.openaiOauthCallbackHint':
    'Po zalogowaniu wklej pełny URL przekierowania z przeglądarki (zaczyna się od http://127.0.0.1:1455/).',
  'onboarding.apiKeys.oauthDesktopOnly':
    'Logowanie przez ChatGPT jest dostępne tylko w aplikacji desktopowej.',
  'onboarding.apiKeys.oauthStartFailed':
    'Nie można uruchomić logowania ChatGPT. Spróbuj ponownie lub użyj klucza API.',
  'onboarding.apiKeys.oauthPasteRedirect':
    'Wklej URL przekierowania z przeglądarki po zalogowaniu.',
  'onboarding.apiKeys.oauthCompleteFailed':
    'Logowanie ChatGPT nie zostało ukończone. Sprawdź URL przekierowania i spróbuj ponownie.',
