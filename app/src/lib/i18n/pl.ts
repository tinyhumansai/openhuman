...
const messages: TranslationMap = {
  ...
  'beliefLedger.confidence': 'Pewność',
  'beliefLedger.confidenceAria': 'Pewność: {pct}%',
  'beliefLedger.conflictBadge': 'Sporne',
  'beliefLedger.correctionCustomLabel': 'Lub wprowadź inną wartość',
  'beliefLedger.correctionFailed': 'Nie udało się zapisać korekty.',
  'beliefLedger.correctionModalMessage':
    'Zapisać wybraną wartość jako potwierdzoną prawdę dla tego stwierdzenia? Agent będzie traktował ją jako autorytatywną w przyszłości.',
  'beliefLedger.correctionModalTitle': 'Ustaw poprawną wartość',
  'beliefLedger.correctionSaved': 'Korekta zapisana.',
  'beliefLedger.correctionSelectAria': 'Wybierz poprawną wartość dla {claim}',
  'beliefLedger.currentBelief': 'bieżące',
  'beliefLedger.distinctValues': '{n} różnych wartości',
  'beliefLedger.empty': 'Brak przekonań do pokazania.',
  'beliefLedger.emptyHint':
    'Gdy agent uczy się faktów o tobie, sprzeczności i poprawki w czasie pojawią się tutaj.',
  'beliefLedger.errorPrefix': 'Nie udało się załadować przekonań:',
  'beliefLedger.evidence': 'Dowód',
  'beliefLedger.evidenceAria': 'Liczba dowodów: {n}',
  'beliefLedger.explain': 'Wyjaśnij tę sprzeczność',
  'beliefLedger.explainAria': 'Wyjaśnij tę sprzeczność dla {claim}',
  'beliefLedger.explaining': 'Wyjaśnianie…',
  'beliefLedger.explanationHeading': 'Wyjaśnienie',
  'beliefLedger.historyHeading': 'Historia rewizji',
  'beliefLedger.intro':
    'Zobacz, jak to, co agent wierzy o tobie, zmieniło się w czasie. Gdy nowsze wspomnienia sprzeciwiają się starszym o tym samym, rejestr pokazuje oba, wybiera bieżące najlepsze przekonanie i pozwala ci je poprawić.',
  'beliefLedger.loading': 'Ładowanie przekonań…',
  'beliefLedger.revision.contradicted': 'zaprzeczone',
  'beliefLedger.revision.refined': 'doprecyzowane',
  'beliefLedger.revision.reinforced': 'wzmocnione',
  'beliefLedger.revision.superseded': 'zastąpione',
  'beliefLedger.setTruth': 'Ustaw prawdę',
  'beliefLedger.setTruthAria': 'Ustaw prawdę dla {claim}',
  'beliefLedger.title': 'Rejestr przekonań',
  'memory.tab.beliefs': 'Przekonania',
};
