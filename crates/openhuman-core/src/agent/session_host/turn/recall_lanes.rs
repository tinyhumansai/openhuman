...
pub(super) async fn append_recall_lanes(
...
async fn situational_preferences(agent: &OpenHumanSessionHost, user_message: &str) -> Vec<String> {
...
async fn auto_recall_block(agent: &OpenHumanSessionHost, user_message: &str) -> Option<String> {
